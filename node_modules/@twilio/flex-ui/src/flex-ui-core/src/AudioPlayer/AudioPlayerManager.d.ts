 ...
 * @classdesc The Flex AudioPlayerManager API supports playing, stopping and muting sounds.
 * To learn more go to [Flex Sounds](https://www.twilio.com/docs/flex/developer/ui/sound-and-audio)
 * @hideconstructor
 * @category Audio
 * @menuorder 100
 */
