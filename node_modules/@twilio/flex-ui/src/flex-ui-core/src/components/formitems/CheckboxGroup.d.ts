 ...
 * @private
 */
interface CheckboxGroupProps extends Omit<ItemProps, "handleBlur"> {
 ...
 * @private
 */
interface CheckboxGroupAttributes {
    name: string;
    required?: boolean;
    readOnly?: boolean;
}
...
declare const CheckboxGroupThemed: React.FC<Pick<CheckboxGroupProps, "error" | "handleChange" | "field" | "handleBlur" | "stateData" | "touched"> & {
    theme?: import("@emotion/react").Theme;
}>;
export { CheckboxGroupThemed as CheckboxGroup };
