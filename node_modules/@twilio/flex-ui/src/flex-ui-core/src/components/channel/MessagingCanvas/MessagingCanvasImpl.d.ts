...
import { MessagingCanvasChildrenProps } from "./MessagingCanvas.definitions";
export declare const displayName = "MessagingCanvas";
export declare const contentStore: DynamicContentStore<MessagingCanvasChildrenProps, "">;
