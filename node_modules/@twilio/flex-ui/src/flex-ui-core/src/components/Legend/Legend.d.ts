...
import { LabelPosition } from "./LegendItem";
/**
 * LegendItemProps
 ...
 * @property {function} [renderMarker] - optional, render function for the marker. (item: LegendItemProps) => React.ReactNode
 * @private
 */
export interface LegendItemProps {
    ...
    displayValue?: string;
    showLabel?: boolean;
    renderMarker?: (item: LegendItemProps) => React.ReactNode;
