...
/**
 * @enum {"AddToConversation" | "DeactivateConversation" | "LeaveConversation"} ChatOrchestration
 * @property {"AddToConversation"} AddToConversation Adds worker to a conversation
 * @property {"DeactivateConversation"} DeactivateConversation Deactivates a conversation
 * @property {"LeaveConversation"} LeaveConversation Leave a conversation
 * @memberof ChatOrchestrator
 */
export declare enum ChatOrchestration {
    AddToConversation = "AddToConversation",
    DeactivateConversation = "DeactivateConversation",
 ...
 * };
 */
export type ChatOrchestrationsCallback = (task: ITask) => Array<ChatOrchestration>;
/**
...
export declare class ChatOrchestrationManager {
     ...
     * @returns {Array<ChatOrchestrator.ChatOrchestration> | ChatOrchestrator.ChatOrchestrationsCallback} Either an Array of orchestrations or orchestrations callback
     * @memberof ChatOrchestrator
     * @example
    ...
    private addWorkerToConversationInternal;
    private deactivateConversationInternal;
