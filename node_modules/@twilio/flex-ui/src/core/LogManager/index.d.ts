import { Formatter, FormatterConfig, PredefinedFormatters } from "./formatters";
import { LogEntry, NotifyCallback, PredefinedSpies, Spy, SpyConfig } from "./spies";
import { PredefinedStorages, Storage, StorageConfig } from "./storages";
import { PredefinedTransports, Transport, TransportConfig } from "./transports";
/**
...
declare class LogManager {
    ...
    isLogging(): boolean;
    /**
     * Returns a snapshot with the current logs
     * @name getLogsSnapshot
     * @function
