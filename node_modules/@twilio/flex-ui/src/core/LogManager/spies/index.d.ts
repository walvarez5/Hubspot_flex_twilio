import { ClassProxySpyConstructorOptions, ClassProxySpyOptions } from "./ClassProxySpy";
import { DOMEventsSpyConstructorOptions, DOMEventsSpyOptions } from "./DOMEventsSpy";
import { EventEmitterSpyConstructorOptions, EventEmitterSpyOptions } from "./EventEmitterSpy";
import { LoglevelSpyConstructorOptions, LoglevelSpyOptions } from "./LoglevelSpy";
import { NotifyCallback, OnStartCallback, Spy } from "./Spy";
 ...
 * })
 */
type SpyConfigurableOptions = SpyTypeOptions & (ClassProxySpyOptions | EventEmitterSpyOptions | DOMEventsSpyOptions | LoglevelSpyOptions);
type ConstructorsOptions = ClassProxySpyConstructorOptions | EventEmitterSpyConstructorOptions | DOMEventsSpyConstructorOptions | LoglevelSpyConstructorOptions;
/**
 * Create a custom spy
 *
 * @callback CreateSpy
 ...
 * @memberof Log
 */
export type SpyConfig = CreateSpy | SpyConfigurableOptions;
type getSpyParams = SpyTypeOptions & ConstructorsOptions;
export declare const getSpy: (options: getSpyParams) => Spy | void;
