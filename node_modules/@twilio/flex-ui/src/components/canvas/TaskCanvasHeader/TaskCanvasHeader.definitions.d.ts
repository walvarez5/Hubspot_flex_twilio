import { ButtonThemeProps, CSSProps } from "../../../flex-ui-core/src";
...
export { TaskCanvasHeaderChildrenKeys } from "../../../internal-flex-commons/src";
/**
...
/**
 * Properties of children in the new task canvas header
 * @private
 */
export interface NewTaskCanvasHeaderChildrenProps {
    task: ITask;
}
