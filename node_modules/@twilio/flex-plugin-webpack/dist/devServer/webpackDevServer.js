...
exports.default = (function (devCompiler, devConfig, type) {
    ...
    var devServer = new webpack_dev_server_1.default(devConfig, devCompiler);
    if (!isStaticServer) {
        // Show TS errors on browser
        devCompiler.hooks.tsCompiled.tap('afterTSCompile', function (warnings, errors) {
            var _a, _b, _c, _d;
            if (warnings.length) {
                devServer.sendMessage((_b = (_a = devServer.webSocketServer) === null || _a === void 0 ? void 0 : _a.clients) !== null && _b !== void 0 ? _b : [], 'warnings', warnings);
            }
            if (errors.length) {
                devServer.sendMessage((_d = (_c = devServer.webSocketServer) === null || _c === void 0 ? void 0 : _c.clients) !== null && _d !== void 0 ? _d : [], 'errors', errors);
            }
        });
    }
    // Start the dev-server
    devServer.startCallback(function (err) { return __awaiter(void 0, void 0, void 0, function () {
        var serverType;
