...
<head>
    <title>Code coverage report for src/core/core.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/core</a> core.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">96.7% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>176/182</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">95.1% </span>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>174/180</span>
            </div>
...
<a name='L432'></a><a href='#L432'>432</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as WS from "wavesurfer.js"
...
&nbsp;
  private wsHandleReady = () =&gt; {
    ...
    const duration = this.ws<span class="branch-0 cbranch-no" title="branch not covered" >?.g</span>etDuration()
    <span class="missing-if-branch" title="if path not taken" >I</span>if (duration &amp;&amp; this.ws &amp;&amp; this.ws.timeline &amp;&amp; this.ws.timeline.params) {
<span class="cstat-no" title="statement not covered" >      this.ws.timeline.params.timeInterval =</span>
...
&nbsp;
      const onCanPlay = () =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.ws &amp;&amp; this.mediaElement) {
          // @ts-ignore
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(seekAt) || !(seekAt &gt;= 0 &amp;&amp; seekAt &lt;= 1)) {
...
<span class="cstat-no" title="statement not covered" >      seekAt = 0</span>
    }
...
<span class="cstat-no" title="statement not covered" >      offset = undefined</span>
<span class="cstat-no" title="statement not covered" >      duration = undefined</span>
    }
&nbsp;
