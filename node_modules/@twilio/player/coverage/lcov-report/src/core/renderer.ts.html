...
<head>
    <title>Code coverage report for src/core/renderer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/core</a> renderer.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">90.91% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>130/143</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>126/136</span>
            </div>
...
<a name='L378'></a><a href='#L378'>378</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as WaveSurfer from "wavesurfer.js"
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hasMinVals) {
<span class="cstat-no" title="statement not covered" >      return peaks.map(<span class="fstat-no" title="function not covered" >peaks </span>=&gt; (<span class="cstat-no" title="statement not covered" >peaks as number[]).filter(<span class="fstat-no" title="function not covered" >(_</span>, i) =&gt; <span class="cstat-no" title="statement not covered" >!(i % 2))</span>)</span></span>
    }
&nbsp;
    return peaks
  }
...
&nbsp;
  private <span class="fstat-no" title="function not covered" >prepareProgressBars(</span>{
    start,
    end,
    step,
  }: {
    ...
    let i = <span class="cstat-no" title="statement not covered" >start</span>
    const heights = <span class="cstat-no" title="statement not covered" >[]</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (i; i &lt; end; i += step) {</span>
<span class="cstat-no" title="statement not covered" >      heights.push(0.5)</span>
    }
<span class="cstat-no" title="statement not covered" >    return [heights]</span>
  }
&nbsp;
...
&nbsp;
    bars[0].forEach((_, index) =&gt; {
      ...
      channels = channels.sort(<span class="fstat-no" title="function not covered" >(a</span>, b) =&gt; <span class="cstat-no" title="statement not covered" >bars[b][index] - bars[a][index])</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!peaks || !peaks.length) {
      // Peaks are not available and Wavesurfer is currently generating them.
      // We display bars going half way.
      const bars = <span class="cstat-no" title="statement not covered" >this.prepareProgressBars({</span>
        start,
        end,
        step,
      })
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.renderBars({ bars, start, step })</span>
    } else {
...
&nbsp;
  public destroyCursor() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.cursorCanvas) {
<span class="cstat-no" title="statement not covered" >      this.cursorCanvas.parentNode?.removeChild(this.cursorCanvas)</span>
<span class="cstat-no" title="statement not covered" >      this.cursorCanvas = undefined</span>
    }
  }
&nbsp;
...
&nbsp;
  public drawCursor(position: number) {
    if (this.cursorCanvas) {
      const ctx = this.cursorCanvas.getContext("2d")
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctx &amp;&amp; this.cursorCanvas) {
        ctx.imageSmoothingEnabled = false
