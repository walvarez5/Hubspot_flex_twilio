...
<head>
    <title>Code coverage report for src/ui/Player.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/ui</a> Player.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable @typescript-eslint/no-non-null-assertion */
...
&nbsp;
  private onError = <span class="fstat-no" title="function not covered" >(e</span>: Error) =&gt; {
<span class="cstat-no" title="statement not covered" >    if (this.props.onError) {</span>
<span class="cstat-no" title="statement not covered" >      this.props.onError(e)</span>
    }
  }
&nbsp;
  private onRedraw = () =&gt; {
