...
var BuildClient = /** @class */ (function () {
    function BuildClient(client, serviceSid) {
        var _this = this;
        /**
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this._create(data)];
                                case 1:
                                    newBuild = _a.sent();
                                    sid = newBuild.sid;
         ...
         */
        this.get = function (sid) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!sids_1.isSidOfType(sid, sids_1.SidPrefix.BuildSid)) {
                    throw new Error(sid + " is not of type " + sids_1.SidPrefix.BuildSid);
                }
                return [2 /*return*/, this.client.get(flex_dev_utils_1.urlJoin('Services', this.serviceSid, 'Builds', sid))];
            });
        }); };
        /**
         ...
         * @private
         */
        this._create = function (data) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.post(flex_dev_utils_1.urlJoin('Services', this.serviceSid, 'Builds'), __assign({}, data), {
                        // Serverless does not follow default Twilio API so we need to overwrite the transform here
                        /* c8 ignore next */
                        transformRequest: function () { return querystring_1.stringify(data); },
                    })];
            });
        }); };
