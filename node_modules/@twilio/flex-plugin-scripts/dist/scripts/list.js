...
var credentials_1 = require("@twilio/flex-dev-utils/dist/credentials");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    visibilities = [];
                    if (publicOnly) {
                        visibilities.push(clients_1.Visibility.Public);
                    }
                    else if (privateOnly) {
                        visibilities.push(clients_1.Visibility.Protected);
                    }
                    else {
                        visibilities.push(clients_1.Visibility.Public);
                        visibilities.push(clients_1.Visibility.Protected);
