...
var _getRuntime = function (credentials) { return __awaiter(void 0, void 0, void 0, function () {
    var runtime, serverlessClient, environmentClient, environment, e_1, pluginName;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                environmentClient = new clients_1.EnvironmentClient(serverlessClient, runtime.service.sid);
                _a.label = 2;
            case 2:
                _a.trys.push([2, 4, , 5]);
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, flex_dev_utils_1.progress("Deleting plugin " + pluginName, function () { return __awaiter(void 0, void 0, void 0, function () {
                        var serverlessClient, environmentClient;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    serverlessClient = new clients_1.ServerlessClient(credentials.username, credentials.password);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, flex_dev_utils_1.confirm(question, 'N')];
            case 1:
                answer = _a.sent();
                if (!answer) {
                    flex_dev_utils_1.exit(0);
