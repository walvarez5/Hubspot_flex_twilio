    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, questions_1.choose(chooseAccount, accounts)];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                return [4 /*yield*/, questions_1.prompt(accountSidQuestion)];
            case 7:
                username = _a.sent();
                return [4 /*yield*/, questions_1.prompt(authTokenQuestion)];
            case 8:
                password = _a.sent();
                _a.label = 9;
            case 9: 
