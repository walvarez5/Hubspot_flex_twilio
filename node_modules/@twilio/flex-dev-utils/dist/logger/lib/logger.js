...
var flex_plugins_utils_env_1 = __importDefault(require("@twilio/flex-plugins-utils-env"));
 ...
 */
var linkText = function (text, url) {
    var OSC = '\u001B]';
    var BEL = '\u0007';
    var SEP = ';';
...
var Logger = /** @class */ (function () {
    function Logger(options) {
        ...
        this.log = function () {
            ...
            _this._log({ level: 'info', markdown: false, args: args });
        };
        /**
         * debug level log
         * @param args
        ...
        this.debug = function () {
            ...
            if (_this.isDebug()) {
                args.unshift('[DEBUG]');
                _this._log({ level: 'info', color: 'dim', args: args });
            }
        };
        /**
         * trace level trace
        ...
        this._log = function (args) {
            if (!_this.isQuiet() || args.level === 'error' || _this.isDebug()) {
                ...
                if (args.markdown === false) {
                    pipe_compose_1.pipe(msg, color, log_1);
                }
                else {
                    pipe_compose_1.pipe(msg, color, _this.markdown, log_1);
                }
            }
        };
        /**
