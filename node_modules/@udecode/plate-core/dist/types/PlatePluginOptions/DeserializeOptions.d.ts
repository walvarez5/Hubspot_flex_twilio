...
export interface GetElementDeserializerOptions extends WithOptional<GetNodeDeserializerOptions, 'getNode'> {
    type: string;
}
export interface GetLeafDeserializerOptions extends WithOptional<Omit<GetNodeDeserializerOptions, 'withoutChildren'>, 'getNode'> {
    type: string;
}
export declare type DeserializeOptions = GetElementDeserializerOptions | GetLeafDeserializerOptions;
//# sourceMappingURL=DeserializeOptions.d.ts.map