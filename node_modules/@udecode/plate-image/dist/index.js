...
const getImageDeserialize = () => editor => {
  const options = plateCore.getPlatePluginOptions(editor, ELEMENT_IMAGE);
  return {
...
const insertImage = (editor, url) => {
  ...
  const image = {
    type: plateCore.getPlatePluginType(editor, ELEMENT_IMAGE),
    url,
    children: [text]
  };
...
const createImagePlugin = options => ({
  ...
  renderElement: plateCore.getRenderElement(ELEMENT_IMAGE),
  deserialize: getImageDeserialize(),
  voidTypes: plateCore.getPlatePluginTypes(ELEMENT_IMAGE),
