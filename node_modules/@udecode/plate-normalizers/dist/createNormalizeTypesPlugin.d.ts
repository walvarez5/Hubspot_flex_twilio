...
export declare const withNormalizeTypes: ({ rules, onError, }: WithNormalizeTypes) => WithOverride;
/**
 * @see {@link withNormalizeTypes}
 */
export declare const createNormalizeTypesPlugin: (options_0: WithNormalizeTypes) => import("@udecode/plate-core").PlatePlugin<import("@udecode/plate-core").SPEditor>;
export {};
