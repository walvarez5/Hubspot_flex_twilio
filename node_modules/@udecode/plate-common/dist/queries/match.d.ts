 ...
 */
export declare const match: <T>(obj: T, predicate?: Predicate<T> | undefined) => boolean;
export declare const matchPredicate: <T>(predicate?: Predicate<T> | undefined) => (obj: T) => boolean;
/**
 ...
 */
export declare const getQueryOptions: <T>(editor: TEditor, options: any) => any;
