...
const getResetNodeOnKeyDown = ({
  ...
  if (editor.selection && plateCommon.isCollapsed(editor.selection)) {
    rules.forEach(({
      types,
      defaultType,
      hotkey,
      ...
      if (hotkey && isHotkey(hotkey, event)) {
        if (predicate(editor) && plateCommon.someNode(editor, {
          match: {
            type: types
          }
        })) {
 ...
 */
const createResetNodePlugin = options => ({
...
exports.getResetNodeOnKeyDown = getResetNodeOnKeyDown;
