...
declare const Theme: {
    ...
    Consumer: {
        ({ children, ...props }: import("./themeConsumer").ThemeConsumerProps): import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
        displayName: string;
    };
};
...
export type { ThemeShape, SendGridThemeShape, ConsoleThemeShape, DarkThemeShape, EvergreenThemeShape, TwilioThemeShape, TwilioDarkThemeShape, } from './types/themes';
export type { GenericThemeShape } from './types/GenericThemeShape';
export { DefaultTheme, ConsoleTheme, SendGridTheme, DarkTheme, EvergreenTheme, TwilioTheme, TwilioDarkTheme, } from './themes';
