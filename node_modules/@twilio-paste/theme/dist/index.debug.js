...
var DefaultTheme = generateThemeFromTokens({
  ...
  dataVisualization: import_design_tokens.dataVisualization,
...
var import_tokens3 = require("@twilio-paste/design-tokens/dist/themes/dark/tokens.common");
var DarkTheme = generateThemeFromTokens({
  ...
  dataVisualization: import_tokens3.dataVisualization,
  colors: import_tokens3.colors
});
...
var TwilioTheme = generateThemeFromTokens({
  ...
  borderColors: import_tokens4.borderColors,
  borderWidths: import_tokens4.borderWidths,
  radii: import_tokens4.radii,
  fonts: import_tokens4.fonts,
  fontSizes: import_tokens4.fontSizes,
  fontWeights: import_tokens4.fontWeights,
  lineHeights: import_tokens4.lineHeights,
  boxShadows: import_tokens4.boxShadows,
  sizings: import_tokens4.sizings,
  spacings: import_tokens4.spacings,
  textColors: import_tokens4.textColors,
  zIndices: import_tokens4.zIndices,
  dataVisualization: import_tokens4.dataVisualization,
  colors: import_tokens4.colors
});
...
var TwilioDarkTheme = generateThemeFromTokens({
  ...
  borderColors: import_tokens5.borderColors,
  borderWidths: import_tokens5.borderWidths,
  radii: import_tokens5.radii,
  fonts: import_tokens5.fonts,
  fontSizes: import_tokens5.fontSizes,
  fontWeights: import_tokens5.fontWeights,
  lineHeights: import_tokens5.lineHeights,
  boxShadows: import_tokens5.boxShadows,
  sizings: import_tokens5.sizings,
  spacings: import_tokens5.spacings,
  textColors: import_tokens5.textColors,
  zIndices: import_tokens5.zIndices,
  dataVisualization: import_tokens5.dataVisualization,
  colors: import_tokens5.colors
});
