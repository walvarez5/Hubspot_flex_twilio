...
import { useEffect as useEffect2, useState, useRef } from "react";
function noop() {
}
...
import { useContext, useMemo, useRef as useRef3, useState as useState2 } from "react";

// ../../../node_modules/@react-spring/animated/dist/react-spring-animated.esm.js
import * as React2 from "react";
import { forwardRef, useRef as useRef2, useCallback, useEffect as useEffect3 } from "react";
...
function useSprings(length, props, deps) {
  ...
  const ctrls = useRef3([...state.ctrls]);
  const updates = [];
...
function useTransition(data, props, deps) {
  ...
  const transitions = [];
  const usedTransitions = useRef3(null);
  ...
  const exitingTransitions = useRef3(/* @__PURE__ */ new Map());
  const forceChange = useRef3(false);
...
function useReducedMotion() {
  const [prefersReducedMotion, setPrefersReducedMotion] = React4.useState(getMediaQueryList().matches);
  React4.useEffect(() => {
