...
var AlertDialogHeader = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, safelySpreadBoxProps(props)), {
    as: "div"
  }), modalHeaderStyles), {
    border: "none",
...
var AlertDialogBody = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(Box2, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, safelySpreadBoxProps2(props)), {
    as: "div"
  }), modalBodyStyles), {
    element,
    id: bodyID,
...
var AlertDialogFooter = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(Box3, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, safelySpreadBoxProps3(props)), {
    as: "div"
  }), modalFooterStyles), {
    border: "none",
    element,
    ...
    variant: "secondary",
    onClick: onDismiss
  }, onDismissLabel), /* @__PURE__ */ React3.createElement(Button, {
...
var AlertDialog = React4.forwardRef((_a, ref) => {
  ...
  const bodyID = useUID();
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, transitions((styles, item) => item && /* @__PURE__ */ React4.createElement(ModalDialogOverlay, {
    isOpen,
    style: { opacity: styles.opacity }
  }, /* @__PURE__ */ React4.createElement(Box4, __spreadProps(__spreadValues({
