...
export declare type AlertDialogContentProps = ModalDialogContentProps;
declare const AlertDialogContent: import("@twilio-paste/styling-library").StyledComponent<import("@react-spring/web").AnimatedProps<{
