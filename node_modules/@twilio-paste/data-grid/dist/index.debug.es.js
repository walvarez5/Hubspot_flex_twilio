...
var DataGrid = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(DataGridContext.Provider, {
    value: dataGridState
  }, /* @__PURE__ */ React2.createElement(Composite, __spreadProps(__spreadValues(__spreadValues({}, props), compositeState), {
    id: dataGridId,
    ref,
    as: Table,
    element,
...
var DataGridHead = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(THead, __spreadProps(__spreadValues({}, props), {
    element,
    ref
  }));
});
...
var DataGridRow = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(CompositeGroup, __spreadProps(__spreadValues(__spreadProps(__spreadValues({
    as: Tr
  }, props), {
    element
  }), dataGridState), {
...
import * as PropTypes8 from "prop-types";

// src/DataGridCell.tsx
import * as React8 from "react";
import * as PropTypes7 from "prop-types";
...
var Td = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(Box2, __spreadProps(__spreadValues({}, safelySpreadBoxProps2(props)), {
    ref,
    as: "td",
    element,
    borderStyle: "solid",
...
import * as PropTypes6 from "prop-types";
...
var Th = React7.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React7.createElement(Box3, __spreadProps(__spreadValues({}, safelySpreadBoxProps3(props)), {
    ref,
    element,
    as: "th",
...
var DataGridCell = (_a) => {
  ...
  return /* @__PURE__ */ React8.createElement(CompositeItem, __spreadProps(__spreadValues(__spreadValues({}, props), dataGridState), {
    element,
    ref: cellRef,
    as: as === "td" ? Td : Th,
...
import * as PropTypes10 from "prop-types";
import { Button } from "@twilio-paste/button";

// ../screen-reader-only/dist/index.es.js
import * as React10 from "react";
import * as PropTypes9 from "prop-types";
...
var ScreenReaderOnly = React10.forwardRef((_a, ref) => {
  ...
  return React10.createElement(Box4, __spreadProps2(__spreadValues2({}, props), { as, border: "none", clip: "rect(0 0 0 0)", height: "1px", margin: "spaceNegative10", overflow: "hidden", padding: "space0", position: "absolute", ref, textTransform: "none", whiteSpace: "nowrap", width: "1px" }), children);
});
...
var DataGridHeaderSortIcon = ({ direction, element }) => {
  switch (direction) {
    case "ascending":
      return /* @__PURE__ */ React11.createElement(ArrowUpIcon, {
        decorative: true,
        element
      });
    case "descending":
      return /* @__PURE__ */ React11.createElement(ArrowDownIcon, {
        decorative: true,
        element
      });
    case "none":
      return /* @__PURE__ */ React11.createElement(UnsortedIcon, {
        decorative: true,
        element
      });
    default:
...
var DataGridHeaderSort = (_a) => {
  ...
  return /* @__PURE__ */ React11.createElement(Button, __spreadValues({
    element,
    variant: "reset",
    size: "reset",
    onClick
...
import * as PropTypes11 from "prop-types";
...
var DataGridBody = React12.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React12.createElement(TBody, __spreadProps(__spreadValues({}, props), {
    element,
    ref
  }));
});
...
import * as PropTypes12 from "prop-types";
...
var DataGridFoot = React13.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React13.createElement(TFoot, __spreadProps(__spreadValues({}, props), {
    element,
    ref
  }));
});
