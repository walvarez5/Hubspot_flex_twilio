...
var DirectButtonPropTypes = {
  ...
  size: PropTypes.oneOf(["small", "default", "icon", "icon_small", "reset", "rounded_small"]).isRequired,
  tabIndex: PropTypes.oneOf([0, -1]),
  type: PropTypes.oneOf(["submit", "button", "reset"]),
  disabled: PropTypes.bool,
  buttonState: PropTypes.oneOf(["disabled", "loading", "default"]).isRequired,
...
var SecondaryButton = React3.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React3.createElement(
      ...
      }, safelySpreadBoxProps3(props)), toggleStyles), ButtonStyleMapping3[buttonState]), SizeStyles[size])
    );
  }
);
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React4.createElement(
      ...
      __spreadValues(__spreadValues(__spreadValues(__spreadValues({
        ...
        "aria-pressed": pressed,
        width: fullWidth ? "100%" : "auto"
      }, safelySpreadBoxProps4(props)), toggleStyles), ButtonStyleMapping4[buttonState]), SizeStyles[size])
    );
  }
);
...
var ButtonContents = ({ buttonState, children, showLoading, variant }) => {
  ...
  return /* @__PURE__ */ React13.createElement(React13.Fragment, null, /* @__PURE__ */ React13.createElement(
    ...
    /* @__PURE__ */ React13.createElement(Spinner, { decorative: true, delay: 0 })
  ) : null);
};
...
var Button = React13.forwardRef(
  (_a, ref) => {
    ...
    if (props.as === "a" && props.href != null && typeof children === "string" && variant !== "reset") {
      injectIconChildren = /* @__PURE__ */ React13.createElement(React13.Fragment, null, children, externalLinkProps != null ? /* @__PURE__ */ React13.createElement(LinkExternalIcon, { decorative: false, title: i18nExternalLinkLabel }) : /* @__PURE__ */ React13.createElement(AnimatedBox, { style: arrowIconStyles }, /* @__PURE__ */ React13.createElement(ArrowForwardIcon, { decorative: true })));
    }
