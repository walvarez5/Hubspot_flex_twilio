...
export type ButtonSizes = 'small' | 'default' | 'icon' | 'icon_small' | 'reset' | 'rounded_small' | 'circle' | 'circle_small';
export type ButtonVariants = 'primary' | 'primary_icon' | 'secondary' | 'secondary_icon' | 'destructive' | 'destructive_icon' | 'destructive_link' | 'destructive_secondary' | 'link' | 'inverse_link' | 'inverse' | 'reset';
