...
$tokens-map: (
  ...
  'color-background-user': (rgb(231, 228, 249)),
  /* Trial account background color. */
  'color-background-trial': (rgb(220, 242, 234)),
  /* Subaccount background color. */
  'color-background-subaccount': (rgb(255, 239, 210)),
  /* Stronger background for primary actions or highlights. */
  'color-background-primary-stronger': (rgb(31, 61, 153)),
  /* Stronger background color used for destructive actions or highlights. */
  'color-background-destructive-stronger': (rgb(125, 40, 40)),
  /* Weaker background for primary actions or highlights. */
  'color-background-primary-weaker': (rgb(235, 240, 255)),
  /* Weaker background color used for destructive actions or highlights. */
  'color-background-destructive-weaker': (rgb(249, 218, 218)),
  /* Warning background color */
  'color-background-warning': (rgb(222, 117, 72)),
  ...
  'color-background-inverse-strong': (rgb(71, 77, 102)),
  /* Background color for indicating a new status. */
  'color-background-new': (rgb(231, 228, 249)),
  /* Strong default background color. */
  'color-background-strong': (rgb(230, 232, 240)),
  ...
  'color-background-destructive': (rgb(209, 67, 67)),
  /* Weak default background color. */
  'color-background-weak': (rgb(249, 250, 252)),
  /* Background for primary actions or highlights. */
  'color-background-primary': (rgb(51, 102, 255)),
  /* Weakest background for primary actions or highlights. */
  'color-background-primary-weakest': (rgb(243, 246, 255)),
  /* Background color used to represent an entity or person as "busy". */
  'color-background-busy': (rgb(222, 117, 72)),
  /* Success background color. */
  'color-background-success': (rgb(82, 189, 148)),
  /* Weakest background color used for destructive actions or highlights. */
  'color-background-destructive-weakest': (rgb(253, 244, 244)),
  /* Color used to represent an entity or person as "offline". */
  'color-background-offline': (rgb(193, 196, 214)),
  /* Background color for alternative striped rows. */
  'color-background-row-striped': (rgb(250, 251, 255)),
  /* Strongest background for primary actions or highlights. */
  'color-background-primary-strongest': (rgb(12, 30, 86)),
  /* Weakest success background color. */
  'color-background-success-weakest': (rgb(238, 248, 244)),
  /* Strongest background color used for destructive actions or highlights. */
  'color-background-destructive-strongest': (rgb(79, 21, 21)),
  /* Strong error background color. */
  'color-background-error-strong': (rgb(167, 54, 54)),
  ...
  'color-background-brand': (rgb(71, 77, 102)),
  /* Error background color. */
  'color-background-error': (rgb(209, 67, 67)),
  /* Weakest neutral background color. */
  'color-background-neutral-weakest': (rgb(244, 246, 250)),
  /* Background color used to represent an entity or person as "available". */
  'color-background-available': (rgb(82, 189, 148)),
  /* Weakest error background color. */
  'color-background-error-weakest': (rgb(253, 244, 244)),
  ...
  'color-background-decorative-40-weakest': (rgb(248, 247, 253)),
  /* Stronger inverse background color for any container. Must be used on color-background-body-inverse. */
  'color-background-inverse-stronger': (rgb(105, 111, 140)),
  /* Weakest background color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative border and/or text tokens. */
  'color-background-decorative-30-weakest': (rgb(238, 248, 244)),
  /* Background color used for the main page body. */
  'color-background-body': (rgb(255, 255, 255)),
  /* Strong background for primary actions or highlights. */
  'color-background-primary-strong': (rgb(41, 82, 204)),
  /* Weakest background color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative border and/or text tokens. */
  'color-background-decorative-20-weakest': (rgb(243, 246, 255)),
  /* Strong background color used for destructive actions or highlights. */
  'color-background-destructive-strong': (rgb(167, 54, 54)),
  /* Weak background color used for destructive actions or highlights. */
  'color-background-destructive-weak': (rgb(244, 182, 182)),
  /* Weakest background color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative border and/or text tokens. */
  'color-background-decorative-10-weakest': (rgb(244, 246, 250)),
  /* Default background color for any container. */
  'color-background': (rgb(244, 246, 250)),
  /* Weak background for primary actions or highlights. */
  'color-background-primary-weak': (rgb(214, 224, 255)),
  /* Stronger default background color. */
  'color-background-stronger': (rgb(193, 196, 214)),
  /* Highlight brand background, accessible with black text. */
  'color-background-brand-highlight': (rgb(82, 189, 148)),
  /* Weakest background color used for brand highlights. */
  'color-background-brand-highlight-weakest': (rgb(220, 242, 234)),
  /* Strongest default background color. */
  'color-background-strongest': (rgb(105, 111, 140)),
  /* Inverse background color used for the main page body. */
  'color-background-body-inverse': (rgb(16, 24, 64)),
  /* Inverse background color for any container. Must be used on color-background-body-inverse. */
  'color-background-inverse': (rgb(16, 24, 64)),
  /* Default background for overlays. */
  'color-background-overlay': (rgb(77, 77, 102)),
  /* Color used to represent an entity or person as "unavailable". */
  'color-background-unavailable': (rgb(209, 67, 67)),
  /* Stronger error background color. */
  'color-background-error-stronger': (rgb(125, 40, 40)),
  ...
  'color-border-error-stronger': (rgb(125, 40, 40)),
  /* Weak warning border color */
  'color-border-warning-weak': (rgb(235, 172, 145)),
  ...
  'color-border-decorative-40-weaker': (rgb(231, 228, 249)),
  /* Weaker error border color */
  'color-border-error-weaker': (rgb(244, 182, 182)),
  /* User avatar border color. */
  'color-border-user': (rgb(231, 220, 250)),
  /* Weaker neutral border color */
  'color-border-neutral-weaker': (rgb(214, 224, 255)),
  /* Warning border color */
  'color-border-warning': (rgb(222, 117, 72)),
  /* Weaker success border color */
  'color-border-success-weaker': (rgb(220, 242, 234)),
  /* Stronger primary border color */
  'color-border-primary-stronger': (rgb(31, 61, 153)),
  /* Stronger destructive hover border color */
  'color-border-destructive-stronger': (rgb(125, 40, 40)),
  /* Weakest warning border color */
  'color-border-warning-weakest': (rgb(248, 227, 218)),
  /* Weaker primary border color */
  'color-border-primary-weaker': (rgb(214, 224, 255)),
  /* Destructive focus border color */
  'color-border-destructive-weaker': (rgb(249, 218, 218)),
  /* Weaker border color for something designated as new */
  'color-border-new-weaker': (rgb(231, 228, 249)),
  /* Destructive border color */
  'color-border-destructive': (rgb(209, 67, 67)),
  ...
  'color-border-primary': (rgb(51, 102, 255)),
  /* Weakest primary border color */
  'color-border-primary-weakest': (rgb(235, 240, 255)),
  /* Success border color */
  'color-border-success': (rgb(82, 189, 148)),
  /* Destructive focus border color */
  'color-border-destructive-weakest': (rgb(253, 244, 244)),
  /* Strongest destructive hover border color */
  'color-border-destructive-strongest': (rgb(49, 12, 12)),
  /* Strongest primary border color */
  'color-border-primary-strongest': (rgb(0, 0, 0)),
  /* Weakest success border color */
  'color-border-success-weakest': (rgb(238, 248, 244)),
  /* Weaker warning border color */
  'color-border-warning-weaker': (rgb(242, 200, 182)),
  /* Strong border color */
  'color-border-strong': (rgb(143, 149, 178)),
  /* Weak border color */
  'color-border-weak': (rgb(230, 232, 240)),
  /* Neutral border color */
  'color-border-neutral': (rgb(51, 102, 255)),
  /* Error border color */
  'color-border-error': (rgb(209, 67, 67)),
  /* Weakest error border color */
  'color-border-error-weakest': (rgb(249, 218, 218)),
  /* Strongest error border color */
  'color-border-error-strongest': (rgb(49, 12, 12)),
  /* Strong error border color */
  'color-border-error-strong': (rgb(167, 54, 54)),
  /* Weak error border color */
  'color-border-error-weak': (rgb(238, 145, 145)),
  /* Weak neutral border color */
  'color-border-neutral-weak': (rgb(157, 181, 255)),
  /* Default border color */
  'color-border': (rgb(216, 218, 229)),
  ...
  'color-border-success-weak': (rgb(163, 230, 205)),
  /* Strong primary border color */
  'color-border-primary-strong': (rgb(41, 82, 204)),
  /* Border on inverse backgrounds. Must be used on color-background-body-inverse. */
  'color-border-inverse': (rgb(136, 145, 170)),
  /* Destructive focus border color */
  'color-border-destructive-strong': (rgb(167, 54, 54)),
  /* Weak primary border color */
  'color-border-primary-weak': (rgb(157, 181, 255)),
  ...
  /* Destructive focus border color */
  'color-border-destructive-weak': (rgb(244, 182, 182)),
  ...
  /* Weaker border color */
  'color-border-weaker': (rgb(237, 239, 245)),
  /* Weaker border color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative background and/or text tokens. */
  'color-border-decorative-10-weaker': (rgb(216, 218, 229)),
  /* Weaker border color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative background and/or text tokens. */
  'color-border-decorative-20-weaker': (rgb(214, 224, 255)),
  /* Weaker border color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative background and/or text tokens. */
  'color-border-decorative-30-weaker': (rgb(238, 248, 244)),
  /* Border radius reset */
  'border-radius-0': (0),
  /* Small border radius */
  ...
  'shadow-border-bottom-new-weaker': (0 1px 0 #D0CAF4),
  /* Default shadow. */
  'shadow': (0 4px 16px 0 rgba(0, 0, 0, 0.5)),
  /* Stronger shadow border for destructive interactions */
  'shadow-border-destructive-stronger': (0 0 0 1px #7D2828),
  ...
  'shadow-border-primary-stronger': (0 0 0 1px #1F3D99),
  /* Weaker bottom shadow border warning warning status */
  'shadow-border-bottom-warning-weaker': (0 1px 0 #F2C8B6),
  /* Weaker shadow border for destructive interactions. */
  'shadow-border-destructive-weaker': (0 0 0 1px #F9DADA),
  /* Weaker shadow border for primary interactions. */
  'shadow-border-primary-weaker': (0 0 0 1px #D6E0FF),
  ...
  'shadow-border-strong': (0 0 0 1px #8F95B2),
  /* Shadow for focus ring on interactive elements. */
  'shadow-focus': (0 0 0 4px #9DB5FF),
  /* Weak shadow border for disabled inputs. */
  'shadow-border-weak': (0 0 0 1px #E6E8F0),
  ...
  'shadow-border-error-weak': (0 0 0 1px #F4B6B6),
  /* Shadow border for error inputs. */
  'shadow-border-error': (0 0 0 1px #D14343),
  /* Weaker bottom shadow border for decorative 10 */
  'shadow-border-bottom-decorative-10-weaker': (0 1px 0 #D8DAE5),
  ...
  'shadow-border-bottom-decorative-20-weaker': (0 1px 0 #D6E0FF),
  ...
  'shadow-border-destructive-strong': (0 0 0 1px #A73636),
  ...
  'shadow-border-bottom-decorative-30-weaker': (0 1px 0 #DCF2EA),
  /* Strong shadow border for inputs hover. */
  'shadow-border-primary-strong': (0 0 0 1px #2952CC),
  /* Weaker shadow border for primary interactions. */
  'shadow-border-primary-weak': (0 0 0 1px #9DB5FF),
  ...
  'shadow-border-bottom-decorative-40-weaker': (0 1px 0 #D0CAF4),
  /* Weak shadow border for destructive interactions. */
  'shadow-border-destructive-weak': (0 0 0 1px #F4B6B6),
  /* Weaker bottom shadow border for error status */
  'shadow-border-bottom-error-weaker': (0 1px 0 #F4B6B6),
  /* Weaker shadow border for disabled inputs. */
  'shadow-border-weaker': (0 0 0 1px #EDEFF5),
  /* Shadow border for inputs. */
  'shadow-border': (0 0 0 1px #D8DAE5),
  /* Weaker bottom shadow border for neutral status */
  'shadow-border-bottom-neutral-weaker': (0 1px 0 #9DB5FF),
  ...
  'shadow-focus-inset': (inset 0 0 0 2px #9DB5FF),
  ...
  'shadow-border-bottom-success-weaker': (0 1px 0 #DCF2EA),
  /* Weaker shadow border for decorative 40 */
  'shadow-border-decorative-40-weaker': (0 0 0 1px #e7dcfa),
  /* Shadow border for error inputs hover. */
  'shadow-border-error-stronger': (0 0 0 1px #7D2828),
  /* Shadow for cards. */
  ...
  'font-family-text': ('SF UI Text', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'),
  'font-family-code': ('SF Mono', Monaco, Inconsolata, 'Fira Mono', 'Droid Sans Mono', 'Source Code Pro', monospace),
  ...
  'font-size-90': (1.25rem),
  'font-size-80': (1.125rem),
  'font-size-70': (1rem),
  'font-size-60': (1rem),
  'font-size-50': (0.825rem),
  'font-size-40': (0.875rem),
  'font-size-30': (0.75rem),
  ...
  'color-data-visualization-10': (rgb(243, 103, 43)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-1': (rgb(4, 162, 174)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-2': (rgb(209, 129, 0)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-3': (rgb(24, 65, 191)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-4': (rgb(122, 103, 233)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-5': (rgb(17, 167, 110)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-6': (rgb(10, 29, 123)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-7': (rgb(221, 54, 173)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-8': (rgb(206, 32, 28)),
  /* Color used for data visualizations. Must be used in a sequence. */
  'color-data-visualization-9': (rgb(105, 140, 247)),
  ...
  'color-text-link-destructive-weak': (rgb(209, 67, 67)),
  /* Stronger shade of link text to be used in interactions */
  'color-text-link-stronger': (rgb(12, 30, 86)),
  ...
  'color-text-icon-offline': (rgb(143, 149, 178)),
  /* Destructive link text */
  'color-text-link-destructive': (rgb(209, 67, 67)),
  /* Stronger primary text. */
  'color-text-primary-stronger': (rgb(3, 11, 93)),
  /* Icon color for indicating success. */
  'color-text-icon-success': (rgb(82, 189, 148)),
  /* Color for warning text. */
  'color-text-warning': (rgb(178, 94, 58)),
  ...
  'color-text-icon-neutral': (rgb(41, 82, 204)),
  /* Color for text indicating a new status. */
  'color-text-new': (rgb(82, 73, 136)),
  /* Icon color for indicating an error. */
  'color-text-icon-error': (rgb(209, 67, 67)),
  ...
  'color-text-icon-available': (rgb(82, 189, 148)),
  /* Stronger shade of destructive link text to be used in interactions */
  'color-text-link-destructive-stronger': (rgb(49, 12, 12)),
  ...
  'color-text-success': (rgb(36, 99, 75)),
  /* Weak body text for visual hierarchy. */
  'color-text-weak': (rgb(105, 111, 140)),
  /* Strongest primary text. */
  'color-text-primary-strongest': (rgb(6, 3, 58)),
  /* Default icon color. */
  'color-text-icon': (rgb(143, 149, 178)),
  /* Link text */
  'color-text-link': (rgb(51, 102, 255)),
  ...
  'color-text-decorative-40': (rgb(110, 98, 182)),
  /* Strong shade of link text to be used in interactions */
  'color-text-link-strong': (rgb(31, 61, 153)),
  ...
  /* Text color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative background and/or border tokens. */
  'color-text-decorative-30': (rgb(49, 113, 89)),
  /* Weak shade of link text to be used in interactions */
  'color-text-link-weak': (rgb(157, 181, 255)),
  /* Text color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative background and/or border tokens. */
  'color-text-decorative-20': (rgb(41, 82, 204)),
  /* Text color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative background and/or border tokens. */
  'color-text-decorative-10': (rgb(105, 111, 140)),
  /* Body text color */
  'color-text': (rgb(71, 77, 102)),
  /* Icon color for indicating a busy status */
  'color-text-icon-busy': (rgb(222, 117, 72)),
  ...
  'color-text-brand-highlight': (rgb(82, 189, 148)),
  ...
  'color-text-weaker': (rgb(143, 149, 178)),
  /* Color for dark warning text. */
  'color-text-warning-strong': (rgb(133, 70, 43)),
  /* Icon color for indicating a warning. */
  'color-text-icon-warning': (rgb(222, 117, 72)),
  /* Stronger error text for inputs and error misc */
  'color-text-error-stronger': (rgb(49, 12, 12)),
  /* Strong shade of destructive link text to be used in interactions */
  'color-text-link-destructive-strong': (rgb(125, 40, 40)),
  'z-index-0': (0),
  'z-index-90': (90),
  'z-index-80': (80),
  'z-index-70': (70),
