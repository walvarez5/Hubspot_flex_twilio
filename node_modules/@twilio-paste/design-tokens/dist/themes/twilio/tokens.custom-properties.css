...
:root {
  ...
  --color-background-primary-weakest: rgb(244, 249, 255);
  ...
  --color-background-error-weakest: rgb(254, 245, 245);
  ...
  --color-background-decorative-40-weakest: rgb(250, 247, 253);
  ...
  /* Weakest background color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative border and/or text tokens. */
  --color-background-decorative-20-weakest: rgb(244, 249, 255);
  ...
  --color-border-destructive: rgb(199, 35, 35);
  ...
  /* Error border color. */
  --color-border-error: rgb(199, 35, 35);
  ...
  --shadow-border-bottom-new-weaker: 0 1px 0 #c8aff0;
  /* Default shadow. */
  ...
  --shadow-border-bottom-warning-weaker: 0 1px 0 #ffb37a;
  ...
  --shadow-focus: 0 0 0 2px #ffffff, 0 0 0 3px #006dfa, 0 0 0 5px #cce4ff;
  ...
  --shadow-border-bottom-decorative-10-weaker: 0 1px 0 #aeb2c1;
  ...
  --shadow-border-bottom-decorative-30-weaker: 0 1px 0 #7beaa5;
  ...
  --shadow-border-bottom-decorative-40-weaker: 0 1px 0 #c8aff0;
  ...
  --color-text-success: rgb(11, 96, 45);
  ...
  --color-text-error-strong: rgb(117, 12, 12);
  ...
  /* Text color with no semantic meaning, used for decorative purposes only. Should generally be used with matching decorative background and/or border tokens. */
  --color-text-decorative-30: rgb(11, 96, 45);
