...
:root {
  ...
  --color-background-subaccount: rgb(31, 48, 76);
  ...
  --color-background-error-weakest: rgb(18, 28, 45);
  ...
  --color-background-decorative-40-weakest: rgb(34, 9, 74);
  ...
  --color-border-primary-weaker: rgb(4, 60, 181);
  /* Destructive focus border color */
  --color-border-destructive-weaker: rgb(74, 11, 11);
  ...
  --color-border-primary: rgb(0, 109, 250);
  /* Weakest primary border color */
  --color-border-primary-weakest: rgb(3, 11, 93);
  /* Success border color */
  --color-border-success: rgb(20, 176, 83);
  /* Destructive focus border color */
  --color-border-destructive-weakest: rgb(49, 12, 12);
  ...
  --color-border-warning-weaker: rgb(195, 83, 35);
  /* Strong border color */
  --color-border-strong: rgb(136, 145, 170);
  /* Weak border color */
  --color-border-weak: rgb(57, 71, 98);
  /* Neutral border color */
  --color-border-neutral: rgb(0, 109, 250);
  /* Error border color */
  ...
  --color-border-error-strong: rgb(245, 138, 138);
  ...
  --shadow-border-bottom-warning-weaker: 0 1px 0 #c35323;
  ...
  --shadow-border-primary-weaker: 0 0 0 1px #043cb5;
  ...
  --shadow-focus: 0 0 0 2px #121c2d, 0 0 0 3px #ffffff, 0 0 0 5px rgba(255, 255, 255, 0.2);
  ...
  --shadow-focus-inverse: 0 0 0 2px #121c2d, 0 0 0 3px #ffffff, 0 0 0 5px rgba(255, 255, 255, 0.2);
  /* Default shadow border for primary interactions. */
  --shadow-border-primary: 0 0 0 1px #006dfa;
  ...
  /* Strong shadow border for error inputs hover. */
  ...
  --shadow-border-bottom-decorative-10-weaker: 0 1px 0 #8891aa;
  ...
  --shadow-border-bottom-decorative-20-weaker: 0 1px 0 #043cb5;
  ...
  --shadow-border-bottom-decorative-30-weaker: 0 1px 0 #0e7c3a;
  /* Strong shadow border for inputs hover. */
  --shadow-border-primary-strong: 0 0 0 1px #99cdff;
  /* Weaker shadow border for primary interactions. */
  --shadow-border-primary-weak: 0 0 0 1px #043cb5;
  ...
  --font-family-display: 'TwilioSansDisplay', 'Inter var experimental', 'Inter var', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif;
  ...
  --color-text-decorative-40: rgb(200, 175, 240);
