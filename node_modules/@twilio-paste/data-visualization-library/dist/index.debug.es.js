...
// src/usePasteHighchartsTheme.tsx
var import_deepmerge = __toESM(require_cjs());
import * as React from "react";
import { ThemeContext } from "@twilio-paste/styling-library";
var usePasteHighchartsTheme = (options) => {
  if (options == null) {
    throw new Error(
  ...
  const colors = React.useMemo(() => {
    ...
    const tokenNames = Object.keys(context.dataVisualization);
  ...
  return (0, import_deepmerge.default)(options, {
    colors,
    chart: {
