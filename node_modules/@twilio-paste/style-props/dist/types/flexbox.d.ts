 ...
 */
export type AlignItemsOptions = Globals | Properties['alignSelf'] | Properties['position'] | 'baseline' | 'normal' | 'stretch';
 ...
 */
export type JustifyItemsOptions = Globals | Properties['justifySelf'] | 'baseline' | 'left' | 'legacy' | 'normal' | 'right' | 'stretch';
 ...
 */
export type JustifyContentOptions = Globals | Properties['justifyContent'] | Properties['position'] | 'left' | 'normal' | 'right';
 ...
 */
export type JustifySelfOptions = Globals | Properties['position'] | 'auto' | 'baseline' | 'left' | 'normal' | 'right' | 'stretch' | string;
export type JustifySelf = ResponsiveValue<Globals | Properties['position'] | 'auto' | 'baseline' | 'left' | 'normal' | 'right' | 'stretch'> | ResponsiveValue<string>;
/**
...
export type AlignSelf = ResponsiveValue<Globals | Properties['position'] | 'auto' | 'baseline' | 'normal' | 'stretch'> | ResponsiveValue<string>;
/**
