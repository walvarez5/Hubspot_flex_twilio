...
export type WidthOptions = keyof ThemeShape['widths'] | '100%' | '100vw' | 'auto' | Properties<TLengthStyledSystem>['width'];
export type MinWidthOptions = keyof ThemeShape['minWidths'] | '100%' | '100vw' | 'auto' | Properties<TLengthStyledSystem>['minWidth'];
export type MaxWidthOptions = keyof ThemeShape['maxWidths'] | '100%' | '100vw' | 'auto' | Properties<TLengthStyledSystem>['maxWidth'];
export type HeightOptions = keyof ThemeShape['heights'] | '100%' | '100vh' | 'auto' | Properties<TLengthStyledSystem>['height'];
export type MinHeightOptions = keyof ThemeShape['minHeights'] | '100%' | '100vh' | 'auto' | Properties<TLengthStyledSystem>['minHeight'];
export type MaxHeightOptions = keyof ThemeShape['maxHeights'] | '100%' | '100vh' | 'auto' | Properties<TLengthStyledSystem>['maxHeight'];
