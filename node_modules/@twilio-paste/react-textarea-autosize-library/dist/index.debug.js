...
function calculateNodeHeight(hiddenTextarea, sizingData, value, minRows = 1, maxRows = 999) {
...
var isIE = typeof document !== "undefined" ? Boolean(document.documentElement.currentStyle) : false;
var getSizingData = (node) => {
  ...
  if (isIE && boxSizing === "border-box") {
    const widthPxValue = Number.parseFloat(width) + Number.parseFloat(borderRightWidth) + Number.parseFloat(borderLeftWidth) + Number.parseFloat(paddingRight) + Number.parseFloat(paddingLeft);
...
// src/useWindowResizeListener.tsx
...
// src/useHiddenTextarea.tsx
var import_react3 = __toESM(require("react"));
var useHiddenTextarea = () => {
  const [hiddenTextarea, setHiddenTextarea] = import_react3.default.useState(null);
...
// src/index.tsx
var TextareaAutosize = (_a, userRef) => {
  var _b = _a, {
    cacheMeasurements,
    maxRows,
    minRows,
  ...
  const isControlled = props.value !== void 0 && onChange !== void 0;
  const ownRef = React4.useRef(null);
  const ref = use_composed_ref_esm_default(ownRef, userRef);
  const heightRef = React4.useRef(0);
  const measurementsCacheRef = React4.useRef();
  ...
  const resizeTextarea = () => {
    ...
    const [height, rowHeight] = calculateNodeHeight(hiddenTextarea, nodeSizingData, node.value || node.placeholder || "x", minRows, maxRows);
  ...
  const handleChange = (event) => {
    var _a2;
    const didUserResize = ((_a2 = ownRef.current) == null ? void 0 : _a2.style.getPropertyPriority("height")) !== "important";
  ...
  return /* @__PURE__ */ React4.createElement("textarea", __spreadProps(__spreadValues({}, props), {
    onChange: handleChange,
    ref
  }));
};
TextareaAutosize.displayName = "TexareaAutosize";
var src_default = /* @__PURE__ */ React4.forwardRef(TextareaAutosize);
