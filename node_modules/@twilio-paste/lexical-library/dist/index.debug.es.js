...
var require_LexicalErrorBoundary_prod = __commonJS({
  "../../../node_modules/@lexical/react/LexicalErrorBoundary.prod.js"(exports, module) {
    "use strict";
...
var require_useLexicalEditable_prod = __commonJS({
  "../../../node_modules/@lexical/react/useLexicalEditable.prod.js"(exports, module) {
    "use strict";
    var b = require_LexicalComposerContext();
    var k = (init_react(), __toCommonJS(react_exports));
...
import * as default3 from "react-dom";
...
var require_LexicalPlainTextPlugin_prod = __commonJS({
  "../../../node_modules/@lexical/react/LexicalPlainTextPlugin.prod.js"(exports) {
    ...
    var l = (init_react(), __toCommonJS(react_exports));
    var m = require_LexicalText();
    var n = require_LexicalUtils();
    var p = (init_react_dom(), __toCommonJS(react_dom_exports));
...
var require_LexicalPlainTextPlugin = __commonJS({
  "../../../node_modules/@lexical/react/LexicalPlainTextPlugin.js"(exports, module) {
    "use strict";
...
var require_LexicalHistoryPlugin_prod = __commonJS({
  "../../../node_modules/@lexical/react/LexicalHistoryPlugin.prod.js"(exports) {
    ...
    var f = (init_react(), __toCommonJS(react_exports));
...
var require_LexicalCheckListPlugin_prod = __commonJS({
  "../../../node_modules/@lexical/react/LexicalCheckListPlugin.prod.js"(exports) {
    ...
    var m = (init_react(), __toCommonJS(react_exports));
    function n(a, c) {
      let b = a.target;
...
var require_LexicalTablePlugin_prod = __commonJS({
  "../../../node_modules/@lexical/react/LexicalTablePlugin.prod.js"(exports) {
    ...
    var x = (init_react(), __toCommonJS(react_exports));
    function y(m) {
...
var require_LexicalAutoLinkPlugin_prod = __commonJS({
  "../../../node_modules/@lexical/react/LexicalAutoLinkPlugin.prod.js"(exports) {
    ...
    var u = require_Lexical();
    var w = (init_react(), __toCommonJS(react_exports));
    function A(a) {
      let b = new URLSearchParams();
      b.append("code", a);
      for (let c = 1; c < arguments.length; c++)
...
var require_LexicalClearEditorPlugin = __commonJS({
  "../../../node_modules/@lexical/react/LexicalClearEditorPlugin.js"(exports, module) {
    "use strict";
...
var require_LexicalEditorRefPlugin = __commonJS({
  "../../../node_modules/@lexical/react/LexicalEditorRefPlugin.js"(exports, module) {
    "use strict";
...
var export_$addUpdateTag = import_lexical.$addUpdateTag;
var export_$applyNodeReplacement = import_lexical.$applyNodeReplacement;
var export_$copyNode = import_lexical.$copyNode;
var export_$createLineBreakNode = import_lexical.$createLineBreakNode;
var export_$createParagraphNode = import_lexical.$createParagraphNode;
var export_$createRangeSelection = import_lexical.$createRangeSelection;
var export_$createTextNode = import_lexical.$createTextNode;
var export_$getAdjacentNode = import_lexical.$getAdjacentNode;
var export_$getNearestNodeFromDOMNode = import_lexical.$getNearestNodeFromDOMNode;
var export_$getNearestRootOrShadowRoot = import_lexical.$getNearestRootOrShadowRoot;
var export_$getNodeByKey = import_lexical.$getNodeByKey;
var export_$getPreviousSelection = import_lexical.$getPreviousSelection;
var export_$getRoot = import_lexical.$getRoot;
var export_$getSelection = import_lexical.$getSelection;
var export_$getTextContent = import_lexical.$getTextContent;
var export_$hasAncestor = import_lexical.$hasAncestor;
var export_$hasUpdateTag = import_lexical.$hasUpdateTag;
var export_$insertNodes = import_lexical.$insertNodes;
var export_$isBlockElementNode = import_lexical.$isBlockElementNode;
var export_$isDecoratorNode = import_lexical.$isDecoratorNode;
var export_$isElementNode = import_lexical.$isElementNode;
var export_$isInlineElementOrDecoratorNode = import_lexical.$isInlineElementOrDecoratorNode;
var export_$isLeafNode = import_lexical.$isLeafNode;
var export_$isLineBreakNode = import_lexical.$isLineBreakNode;
var export_$isNodeSelection = import_lexical.$isNodeSelection;
var export_$isParagraphNode = import_lexical.$isParagraphNode;
var export_$isRangeSelection = import_lexical.$isRangeSelection;
var export_$isRootOrShadowRoot = import_lexical.$isRootOrShadowRoot;
var export_$nodesOfType = import_lexical.$nodesOfType;
var export_$parseSerializedNode = import_lexical.$parseSerializedNode;
var export_$selectAll = import_lexical.$selectAll;
var export_$setCompositionKey = import_lexical.$setCompositionKey;
var export_$setSelection = import_lexical.$setSelection;
var export_$splitNode = import_lexical.$splitNode;
var export_AutoFocusPlugin = import_LexicalAutoFocusPlugin.AutoFocusPlugin;
var export_AutoLinkNode = import_link.AutoLinkNode;
var export_AutoLinkPlugin = import_LexicalAutoLinkPlugin.AutoLinkPlugin;
var export_BLUR_COMMAND = import_lexical.BLUR_COMMAND;
var export_CAN_REDO_COMMAND = import_lexical.CAN_REDO_COMMAND;
var export_CAN_UNDO_COMMAND = import_lexical.CAN_UNDO_COMMAND;
var export_CLEAR_EDITOR_COMMAND = import_lexical.CLEAR_EDITOR_COMMAND;
var export_CLEAR_HISTORY_COMMAND = import_lexical.CLEAR_HISTORY_COMMAND;
var export_CLICK_COMMAND = import_lexical.CLICK_COMMAND;
var export_COMMAND_PRIORITY_CRITICAL = import_lexical.COMMAND_PRIORITY_CRITICAL;
var export_COMMAND_PRIORITY_EDITOR = import_lexical.COMMAND_PRIORITY_EDITOR;
var export_COMMAND_PRIORITY_HIGH = import_lexical.COMMAND_PRIORITY_HIGH;
var export_COMMAND_PRIORITY_LOW = import_lexical.COMMAND_PRIORITY_LOW;
var export_COMMAND_PRIORITY_NORMAL = import_lexical.COMMAND_PRIORITY_NORMAL;
var export_CONTROLLED_TEXT_INSERTION_COMMAND = import_lexical.CONTROLLED_TEXT_INSERTION_COMMAND;
var export_COPY_COMMAND = import_lexical.COPY_COMMAND;
var export_CUT_COMMAND = import_lexical.CUT_COMMAND;
var export_CheckListPlugin = import_LexicalCheckListPlugin.CheckListPlugin;
var export_ClearEditorPlugin = import_LexicalClearEditorPlugin.ClearEditorPlugin;
var export_ContentEditable = import_LexicalContentEditable.ContentEditable;
var export_DELETE_CHARACTER_COMMAND = import_lexical.DELETE_CHARACTER_COMMAND;
var export_DELETE_LINE_COMMAND = import_lexical.DELETE_LINE_COMMAND;
var export_DELETE_WORD_COMMAND = import_lexical.DELETE_WORD_COMMAND;
var export_DRAGEND_COMMAND = import_lexical.DRAGEND_COMMAND;
var export_DRAGOVER_COMMAND = import_lexical.DRAGOVER_COMMAND;
var export_DRAGSTART_COMMAND = import_lexical.DRAGSTART_COMMAND;
var export_DROP_COMMAND = import_lexical.DROP_COMMAND;
var export_EditorRefPlugin = import_LexicalEditorRefPlugin.EditorRefPlugin;
var export_ErrorBoundary = import_LexicalErrorBoundary.default;
var export_FOCUS_COMMAND = import_lexical.FOCUS_COMMAND;
var export_FORMAT_ELEMENT_COMMAND = import_lexical.FORMAT_ELEMENT_COMMAND;
var export_FORMAT_TEXT_COMMAND = import_lexical.FORMAT_TEXT_COMMAND;
var export_HistoryPlugin = import_LexicalHistoryPlugin.HistoryPlugin;
var export_INDENT_CONTENT_COMMAND = import_lexical.INDENT_CONTENT_COMMAND;
var export_INSERT_LINE_BREAK_COMMAND = import_lexical.INSERT_LINE_BREAK_COMMAND;
var export_INSERT_PARAGRAPH_COMMAND = import_lexical.INSERT_PARAGRAPH_COMMAND;
var export_INSERT_TAB_COMMAND = import_lexical.INSERT_TAB_COMMAND;
var export_KEY_ARROW_DOWN_COMMAND = import_lexical.KEY_ARROW_DOWN_COMMAND;
var export_KEY_ARROW_LEFT_COMMAND = import_lexical.KEY_ARROW_LEFT_COMMAND;
var export_KEY_ARROW_RIGHT_COMMAND = import_lexical.KEY_ARROW_RIGHT_COMMAND;
var export_KEY_ARROW_UP_COMMAND = import_lexical.KEY_ARROW_UP_COMMAND;
var export_KEY_BACKSPACE_COMMAND = import_lexical.KEY_BACKSPACE_COMMAND;
var export_KEY_DELETE_COMMAND = import_lexical.KEY_DELETE_COMMAND;
var export_KEY_DOWN_COMMAND = import_lexical.KEY_DOWN_COMMAND;
var export_KEY_ENTER_COMMAND = import_lexical.KEY_ENTER_COMMAND;
var export_KEY_ESCAPE_COMMAND = import_lexical.KEY_ESCAPE_COMMAND;
var export_KEY_MODIFIER_COMMAND = import_lexical.KEY_MODIFIER_COMMAND;
var export_KEY_SPACE_COMMAND = import_lexical.KEY_SPACE_COMMAND;
var export_KEY_TAB_COMMAND = import_lexical.KEY_TAB_COMMAND;
var export_LexicalComposer = import_LexicalComposer.LexicalComposer;
var export_LinkPlugin = import_LexicalLinkPlugin.LinkPlugin;
var export_ListPlugin = import_LexicalListPlugin.ListPlugin;
var export_MOVE_TO_END = import_lexical.MOVE_TO_END;
var export_MOVE_TO_START = import_lexical.MOVE_TO_START;
var export_OUTDENT_CONTENT_COMMAND = import_lexical.OUTDENT_CONTENT_COMMAND;
var export_OnChangePlugin = import_LexicalOnChangePlugin.OnChangePlugin;
var export_PASTE_COMMAND = import_lexical.PASTE_COMMAND;
var export_PlainTextPlugin = import_LexicalPlainTextPlugin.PlainTextPlugin;
var export_REDO_COMMAND = import_lexical.REDO_COMMAND;
var export_REMOVE_TEXT_COMMAND = import_lexical.REMOVE_TEXT_COMMAND;
var export_RichTextPlugin = import_LexicalRichTextPlugin.RichTextPlugin;
var export_SELECTION_CHANGE_COMMAND = import_lexical.SELECTION_CHANGE_COMMAND;
var export_SELECT_ALL_COMMAND = import_lexical.SELECT_ALL_COMMAND;
var export_TablePlugin = import_LexicalTablePlugin.TablePlugin;
var export_UNDO_COMMAND = import_lexical.UNDO_COMMAND;
var export_createCommand = import_lexical.createCommand;
var export_useLexicalComposerContext = import_LexicalComposerContext.useLexicalComposerContext;
export {
  export_$addUpdateTag as $addUpdateTag,
  export_$applyNodeReplacement as $applyNodeReplacement,
  export_$copyNode as $copyNode,
  export_$createLineBreakNode as $createLineBreakNode,
  export_$createParagraphNode as $createParagraphNode,
  export_$createRangeSelection as $createRangeSelection,
  export_$createTextNode as $createTextNode,
  export_$getAdjacentNode as $getAdjacentNode,
  export_$getNearestNodeFromDOMNode as $getNearestNodeFromDOMNode,
  export_$getNearestRootOrShadowRoot as $getNearestRootOrShadowRoot,
  export_$getNodeByKey as $getNodeByKey,
  export_$getPreviousSelection as $getPreviousSelection,
  export_$getRoot as $getRoot,
  export_$getSelection as $getSelection,
  export_$getTextContent as $getTextContent,
  export_$hasAncestor as $hasAncestor,
  export_$hasUpdateTag as $hasUpdateTag,
  export_$insertNodes as $insertNodes,
  export_$isBlockElementNode as $isBlockElementNode,
  export_$isDecoratorNode as $isDecoratorNode,
  export_$isElementNode as $isElementNode,
  export_$isInlineElementOrDecoratorNode as $isInlineElementOrDecoratorNode,
  export_$isLeafNode as $isLeafNode,
  export_$isLineBreakNode as $isLineBreakNode,
  export_$isNodeSelection as $isNodeSelection,
  export_$isParagraphNode as $isParagraphNode,
  export_$isRangeSelection as $isRangeSelection,
  export_$isRootOrShadowRoot as $isRootOrShadowRoot,
  export_$nodesOfType as $nodesOfType,
  export_$parseSerializedNode as $parseSerializedNode,
  export_$selectAll as $selectAll,
  export_$setCompositionKey as $setCompositionKey,
  export_$setSelection as $setSelection,
  export_$splitNode as $splitNode,
  export_AutoFocusPlugin as AutoFocusPlugin,
  export_AutoLinkNode as AutoLinkNode,
  export_AutoLinkPlugin as AutoLinkPlugin,
  export_BLUR_COMMAND as BLUR_COMMAND,
  export_CAN_REDO_COMMAND as CAN_REDO_COMMAND,
  export_CAN_UNDO_COMMAND as CAN_UNDO_COMMAND,
  export_CLEAR_EDITOR_COMMAND as CLEAR_EDITOR_COMMAND,
  export_CLEAR_HISTORY_COMMAND as CLEAR_HISTORY_COMMAND,
  export_CLICK_COMMAND as CLICK_COMMAND,
  ...
  export_CONTROLLED_TEXT_INSERTION_COMMAND as CONTROLLED_TEXT_INSERTION_COMMAND,
  export_COPY_COMMAND as COPY_COMMAND,
  export_CUT_COMMAND as CUT_COMMAND,
  ...
  export_DELETE_CHARACTER_COMMAND as DELETE_CHARACTER_COMMAND,
  export_DELETE_LINE_COMMAND as DELETE_LINE_COMMAND,
  export_DELETE_WORD_COMMAND as DELETE_WORD_COMMAND,
  export_DRAGEND_COMMAND as DRAGEND_COMMAND,
  export_DRAGOVER_COMMAND as DRAGOVER_COMMAND,
  export_DRAGSTART_COMMAND as DRAGSTART_COMMAND,
  export_DROP_COMMAND as DROP_COMMAND,
  export_EditorRefPlugin as EditorRefPlugin,
  export_ErrorBoundary as ErrorBoundary,
  export_FOCUS_COMMAND as FOCUS_COMMAND,
  export_FORMAT_ELEMENT_COMMAND as FORMAT_ELEMENT_COMMAND,
  export_FORMAT_TEXT_COMMAND as FORMAT_TEXT_COMMAND,
  export_HistoryPlugin as HistoryPlugin,
  export_INDENT_CONTENT_COMMAND as INDENT_CONTENT_COMMAND,
  export_INSERT_LINE_BREAK_COMMAND as INSERT_LINE_BREAK_COMMAND,
  export_INSERT_PARAGRAPH_COMMAND as INSERT_PARAGRAPH_COMMAND,
  export_INSERT_TAB_COMMAND as INSERT_TAB_COMMAND,
  export_KEY_ARROW_DOWN_COMMAND as KEY_ARROW_DOWN_COMMAND,
  export_KEY_ARROW_LEFT_COMMAND as KEY_ARROW_LEFT_COMMAND,
  export_KEY_ARROW_RIGHT_COMMAND as KEY_ARROW_RIGHT_COMMAND,
  export_KEY_ARROW_UP_COMMAND as KEY_ARROW_UP_COMMAND,
  export_KEY_BACKSPACE_COMMAND as KEY_BACKSPACE_COMMAND,
  export_KEY_DELETE_COMMAND as KEY_DELETE_COMMAND,
  export_KEY_DOWN_COMMAND as KEY_DOWN_COMMAND,
  export_KEY_ENTER_COMMAND as KEY_ENTER_COMMAND,
  export_KEY_ESCAPE_COMMAND as KEY_ESCAPE_COMMAND,
  export_KEY_MODIFIER_COMMAND as KEY_MODIFIER_COMMAND,
  export_KEY_SPACE_COMMAND as KEY_SPACE_COMMAND,
  export_KEY_TAB_COMMAND as KEY_TAB_COMMAND,
  export_LexicalComposer as LexicalComposer,
  export_LinkPlugin as LinkPlugin,
  export_ListPlugin as ListPlugin,
  export_MOVE_TO_END as MOVE_TO_END,
  export_MOVE_TO_START as MOVE_TO_START,
  export_OUTDENT_CONTENT_COMMAND as OUTDENT_CONTENT_COMMAND,
  export_OnChangePlugin as OnChangePlugin,
  export_PASTE_COMMAND as PASTE_COMMAND,
  export_PlainTextPlugin as PlainTextPlugin,
  export_REDO_COMMAND as REDO_COMMAND,
  export_REMOVE_TEXT_COMMAND as REMOVE_TEXT_COMMAND,
  export_RichTextPlugin as RichTextPlugin,
  export_SELECTION_CHANGE_COMMAND as SELECTION_CHANGE_COMMAND,
  export_SELECT_ALL_COMMAND as SELECT_ALL_COMMAND,
  export_TablePlugin as TablePlugin,
  export_UNDO_COMMAND as UNDO_COMMAND,
  export_createCommand as createCommand,
