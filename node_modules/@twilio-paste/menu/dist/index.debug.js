...
// src/useMenuState.ts
var import_menu_primitive = require("@twilio-paste/menu-primitive");

// src/Menu.tsx
var React = __toESM(require("react"));
var import_box = require("@twilio-paste/box");
var import_menu_primitive2 = require("@twilio-paste/menu-primitive");
...
var Menu = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(import_menu_primitive2.MenuPrimitive, __spreadProps(__spreadValues({}, props), { element, as: StyledMenu, ref }));
});
Menu.displayName = "Menu";

// src/MenuButton.tsx
var React2 = __toESM(require("react"));
var import_menu_primitive3 = require("@twilio-paste/menu-primitive");
...
var MenuButton = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(import_menu_primitive3.MenuPrimitiveButton, __spreadProps(__spreadValues({}, props), { element, as: import_button.Button, ref }), props.children);
});
...
var MenuGroup = React3.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React3.createElement(MenuGroupContext.Provider, { value: MenuItemVariants.GROUP_ITEM }, /* @__PURE__ */ React3.createElement(
      ...
      /* @__PURE__ */ React3.createElement(import_box2.Box, { display: "flex", alignItems: "center", paddingX: "space70", paddingY: "space30", cursor: "default" }, React3.isValidElement(icon) ? /* @__PURE__ */ React3.createElement(import_box2.Box, { flexShrink: 0, size: "sizeIcon30" }, React3.cloneElement(icon, { color: "colorTextIcon" })) : null, /* @__PURE__ */ React3.createElement(
        import_text.Text,
        {
          as: "span",
          color: "colorText",
...
var import_menu_primitive4 = require("@twilio-paste/menu-primitive");
var StyledMenuItem = React4.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React4.createElement(
      import_box3.Box,
      __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, href && (0, import_anchor.secureExternalLink)(href)), {
        href,
        as: href ? "a" : "button"
...
var MenuItem = React4.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React4.createElement(import_menu_primitive4.MenuPrimitiveItem, __spreadProps(__spreadValues({}, props), { element, variant, as, ref }));
  }
);
...
var import_separator = require("@twilio-paste/separator");
var import_menu_primitive5 = require("@twilio-paste/menu-primitive");
var StyledMenuSeparator = React5.forwardRef((props, ref) => {
  return /* @__PURE__ */ React5.createElement(import_separator.Separator, __spreadProps(__spreadValues({}, props), { orientation: "horizontal", verticalSpacing: "space40", ref }));
});
...
var MenuSeparator = React5.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React5.createElement(import_menu_primitive5.MenuPrimitiveSeparator, __spreadProps(__spreadValues({}, props), { element, as: StyledMenuSeparator, ref }));
  }
);
...
var import_menu_primitive6 = require("@twilio-paste/menu-primitive");
...
var SubMenuButton = React6.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React6.createElement(import_menu_primitive6.MenuPrimitiveButton, __spreadProps(__spreadValues({}, props), { as: StyledMenuItem, element, ref }), /* @__PURE__ */ React6.createElement(import_media_object.MediaObject, { as: "span", verticalAlign: "center", element: `${element}_MEDIA_OBJECT` }, props.children && /* @__PURE__ */ React6.createElement(import_media_object.MediaBody, { as: "span", element: `${element}_MEDIA_BODY` }, props.children), /* @__PURE__ */ React6.createElement(import_media_object.MediaFigure, { as: "span", align: "end", spacing: "space20", element: `${element}_MEDIA_FIGURE` }, /* @__PURE__ */ React6.createElement(import_ChevronRightIcon.ChevronRightIcon, { decorative: true, size: "sizeIcon30", element: `${element}_ICON` }))));
  }
);
