...
var CustomizationProvider = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement(StyledThemeProvider, { theme: customTheme }, /* @__PURE__ */ React.createElement(StylingGlobals, { styles: pasteGlobalStyles({ theme: customTheme }) }), /* @__PURE__ */ React.createElement(StyledBase, __spreadValues({}, props)));
};
...
var CustomizationConsumer = (props) => {
  return /* @__PURE__ */ React2.createElement(Theme.Consumer, __spreadValues({}, props));
};
