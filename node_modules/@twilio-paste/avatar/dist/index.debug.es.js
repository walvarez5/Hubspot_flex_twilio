...
var AvatarContents = ({ name, size = DEFAULT_SIZE, src, icon: Icon }) => {
  ...
  if (src != null) {
    return /* @__PURE__ */ React.createElement(Box, { as: "img", alt: name, maxWidth: "100%", src, size, title: name });
  }
  if (Icon != null) {
    ...
    return /* @__PURE__ */ React.createElement(Box, { maxWidth: "100%", size, display: "flex", alignItems: "center", justifyContent: "center" }, /* @__PURE__ */ React.createElement(Icon, { decorative: false, title: name, size: computedTokenNames.iconSize }));
  }
...
var Avatar = React.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(
      Box,
      __spreadValues(__spreadValues(__spreadProps(__spreadValues({}, safelySpreadBoxProps(props)), {
        as: "div",
        element,
        overflow: "hidden",
        textAlign: "center",
...
Avatar.propTypes = {
  ...
  variant: PropTypes.oneOf(["user", "entity"]),
  icon: (props) => {
