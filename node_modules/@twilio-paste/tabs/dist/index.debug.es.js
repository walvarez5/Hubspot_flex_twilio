...
var Tabs = React2.forwardRef(
  (_a, ref) => {
    ...
    const _a2 = state || useTabPrimitiveState(__spreadValues({ orientation }, initialState)), { orientation: tabOrientation = orientation } = _a2, tab = __objRest(_a2, ["orientation"]);
    ...
    if (tabOrientation === "vertical") {
      return /* @__PURE__ */ React2.createElement(Flex, { element: elementName, ref, wrap: false, vAlignContent: "stretch" }, returnValue);
    }
    return /* @__PURE__ */ React2.createElement(Box, { element: elementName }, returnValue);
  }
);
Tabs.propTypes = {
  element: PropTypes.string,
  selectedId: PropTypes.string,
  orientation: PropTypes.oneOf(["horizontal", "vertical", void 0]),
...
var Tab = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(
    ...
    (props) => {
      return /* @__PURE__ */ React3.createElement(
        Box2,
        __spreadProps(__spreadValues(__spreadValues({}, safelySpreadBoxProps(props)), boxStyles), {
          as: "span",
...
var TabList = React4.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(TabPrimitiveList, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, tab), { as: Box3 }), props), { element: elementName, ref }), /* @__PURE__ */ React4.createElement(TabListWrapper, { element: `${elementName}_CHILD` }, children));
});
TabList.propTypes = {
  "aria-label": PropTypes3.string.isRequired,
  focusable: PropTypes3.bool,
...
var TabPanel = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(TabPrimitivePanel, __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, tab), tabPanelStyles), props), { element: elementName, as: Box4, ref }), children);
});
if (false) {
  TabPanel.propTypes = {
...
var TabPanels = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(Box5, __spreadProps(__spreadValues({}, safelySpreadBoxProps2(props)), { element: elementName, width: "100%", ref }), children);
});
if (false) {
  TabPanels.propTypes = {
