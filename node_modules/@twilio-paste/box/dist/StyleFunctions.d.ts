 ...
 */
export declare const getPseudoStyles: (props: Partial<StyledBoxProps>) => Record<string, never> | ((props?: Record<string, unknown> | undefined) => CSSObject);
/**
 ...
 */
export declare const getCustomElementStyles: (props: StyledBoxProps) => (() => PasteCustomCSS) | Record<string, never>;
