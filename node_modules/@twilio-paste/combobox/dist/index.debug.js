...
var require_includes = __commonJS({
  "../../../../node_modules/lodash/includes.js"(exports, module2) {
...
__export(src_exports, {
  Combobox: () => Combobox,
  ComboboxInputWrapper: () => ComboboxInputWrapper,
  ComboboxListbox: () => ComboboxListbox,
  ComboboxListboxGroup: () => ComboboxListboxGroup,
  ComboboxListboxOption: () => ComboboxListboxOption,
  MultiselectCombobox: () => MultiselectCombobox,
  useCombobox: () => import_combobox_primitive3.useComboboxPrimitive
});
module.exports = __toCommonJS(src_exports);
var import_combobox_primitive3 = require("@twilio-paste/combobox-primitive");
...
var ComboboxInputSelect = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(import_input.InputElement, __spreadValues({
...
var ComboboxInputWrapper = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(import_box.Box, __spreadProps(__spreadValues({}, (0, import_box.safelySpreadBoxProps)(props2)), {
    ref,
    display: "flex",
    position: "relative",
    width: "100%"
...
var ComboboxListbox = React4.forwardRef((_a, ref) => {
  ...
  if (hidden) {
    return /* @__PURE__ */ React4.createElement(import_box2.Box, __spreadProps(__spreadValues({}, (0, import_box2.safelySpreadBoxProps)(props2)), {
      appearance: "none",
      ref
    }));
  }
...
var ComboboxListboxOption = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(import_box3.Box, __spreadValues(__spreadValues(__spreadProps(__spreadValues({
    role: "option"
  }, (0, import_box3.safelySpreadBoxProps)(props2)), {
  ...
  }), virtualItemStyles), VariantStyles[variant]), /* @__PURE__ */ React5.createElement(import_box3.Box, {
    as: "span"
  }, /* @__PURE__ */ React5.createElement(import_text.Text, {
    as: "span",
    color: "inherit",
    element: `${element}_LIST_ITEM_TEXT`
  }, children)), /* @__PURE__ */ React5.createElement(import_box3.Box, {
    as: "span",
    hidden: selected ? false : true
  }, /* @__PURE__ */ React5.createElement(import_SelectedIcon.SelectedIcon, {
    decorative: true,
    color: "inherit"
  })));
});
...
var ComboboxListboxGroup = React6.forwardRef(({ children, element = "COMBOBOX", groupName, groupLabelTemplate }, ref) => {
  return /* @__PURE__ */ React6.createElement(import_box4.Box, {
    as: "ul",
    ref,
    ...
    padding: "space0",
    listStyleType: "none"
  }, groupName ? /* @__PURE__ */ React6.createElement(import_box4.Box, {
    as: "li",
  ...
  }, /* @__PURE__ */ React6.createElement(import_text2.Text, {
    as: "span",
  ...
  if (groupItemsBy == null) {
    if (virtualItems.length === 0 && EmptyState != null) {
      return /* @__PURE__ */ React7.createElement(ComboboxListboxGroup, {
        element,
        ref
      }, /* @__PURE__ */ React7.createElement(import_box5.Box, {
        as: "li",
        role: "option",
        position: "relative",
...
var import_combobox_primitive = require("@twilio-paste/combobox-primitive");
...
var getDefaultState = ({
  ...
  return (0, import_combobox_primitive.useComboboxPrimitive)(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({
    initialSelectedItem,
    items,
...
var Combobox = React9.forwardRef((_a, ref) => {
  ...
  const { width } = (0, import_utils.useWindowSize)();
  const {
    getComboboxProps,
    getInputProps,
    getItemProps,
  ...
  return /* @__PURE__ */ React9.createElement(import_box6.Box, {
    position: "relative",
    element: `${element}_WRAPPER`
  }, /* @__PURE__ */ React9.createElement(import_label.Label, __spreadValues({
    disabled,
    required,
    variant
  }, getLabelProps()), labelText), /* @__PURE__ */ React9.createElement(import_input_box.InputBox, {
    disabled,
    element,
    hasError,
    insertBefore,
  ...
  })), !autocomplete && /* @__PURE__ */ React9.createElement(import_input_box.InputChevronWrapper, {
    element: `${element}_CHEVRON_WRAPPER`
  }, /* @__PURE__ */ React9.createElement(import_ChevronDownIcon.ChevronDownIcon, {
    decorative: true,
    ...
    emptyState
  })), helpText && /* @__PURE__ */ React9.createElement(import_help_text.HelpText, {
    id: helpTextId,
...
var import_ChevronDownIcon2 = require("@twilio-paste/icons/cjs/ChevronDownIcon");
var import_box8 = require("@twilio-paste/box");
var import_label2 = require("@twilio-paste/label");
...
var import_combobox_primitive2 = require("@twilio-paste/combobox-primitive");
var import_input_box2 = require("@twilio-paste/input-box");

// src/multiselect/GrowingInput.tsx
var React10 = __toESM(require("react"));
var import_box7 = require("@twilio-paste/box");
var import_input2 = require("@twilio-paste/input");
var GrowingInput = React10.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React10.createElement(import_box7.Box, {
  ...
  }, /* @__PURE__ */ React10.createElement(import_input2.InputElement, __spreadProps(__spreadValues({}, props2), {
    ref,
    element,
    type: "text",
    value: text,
...
var MultiselectCombobox = React11.forwardRef((_a, ref) => {
  ...
  const a11yLabelId = (0, import_uid_library2.useUID)();
  const helpTextId = (0, import_uid_library2.useUID)();
  const pillState = (0, import_form_pill_group.useFormPillState)();
  const parentRef = React11.useRef(null);
  const { width } = (0, import_utils2.useWindowSize)();
  ...
  const {
    ...
    addSelectedItem,
    selectedItems
  } = (0, import_combobox_primitive2.useMultiSelectPrimitive)({
    initialSelectedItems,
    onSelectedItemsChange
  });
  const {
    ...
    getItemProps,
    highlightedIndex
  } = (0, import_combobox_primitive2.useComboboxPrimitive)({
    items,
    itemToString,
    selectedItem: null,
    ...
    stateReducer(_state, actionAndChanges) {
      ...
      switch (type) {
        case import_combobox_primitive2.useComboboxPrimitive.stateChangeTypes.InputKeyDownEnter:
        case import_combobox_primitive2.useComboboxPrimitive.stateChangeTypes.ItemClick:
        case import_combobox_primitive2.useComboboxPrimitive.stateChangeTypes.InputBlur:
        ...
        case import_combobox_primitive2.useComboboxPrimitive.stateChangeTypes.MenuMouseLeave:
  ...
  return /* @__PURE__ */ React11.createElement(import_box8.Box, {
    position: "relative",
    element: `${element}_WRAPPER`
  }, /* @__PURE__ */ React11.createElement(import_label2.Label, __spreadValues({
    disabled,
    required,
    variant
  }, getLabelProps()), labelText), /* @__PURE__ */ React11.createElement(import_input_box2.InputBox, {
    disabled,
    hasError,
    element,
    insertBefore,
    insertAfter,
    variant
  }, /* @__PURE__ */ React11.createElement(import_box8.Box, __spreadProps(__spreadValues(__spreadValues({}, getToggleButtonProps({ disabled })), comboboxProps), {
    ...
    maxHeight,
    overflowY: "auto"
  }), /* @__PURE__ */ React11.createElement(import_form_pill_group.FormPillGroup, __spreadProps(__spreadValues({}, pillState), {
    ...
    return /* @__PURE__ */ React11.createElement(import_form_pill_group.FormPill, __spreadValues({
  ...
  })), /* @__PURE__ */ React11.createElement(import_box8.Box, {
    as: "span",
    marginLeft: "space20"
    ...
    "aria-describedby": helpTextId,
    element: `${element}_ELEMENT`
  }))), /* @__PURE__ */ React11.createElement(import_input_box2.InputChevronWrapper, {
    element: `${element}_CHEVRON_WRAPPER`
  }, /* @__PURE__ */ React11.createElement(import_ChevronDownIcon2.ChevronDownIcon, {
    decorative: true,
    color: (0, import_input_box2.getInputChevronIconColor)("default", false, false),
    size: "sizeIcon30"
    ...
    groupLabelTemplate,
    emptyState
  })), helpText && /* @__PURE__ */ React11.createElement(import_help_text2.HelpText, {
    id: helpTextId,
    variant: getHelpTextVariant(variant, hasError),
    element: `${element}_HELP_TEXT`
  }, helpText), /* @__PURE__ */ React11.createElement(import_screen_reader_only.ScreenReaderOnly, {
    id: a11yLabelId
  }, i18nKeyboardControls));
});
