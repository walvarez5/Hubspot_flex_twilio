 ...
 * @return {*}  {DesignToken[]} array of design tokens
 */
export declare const getTokensWithDataVisualizationContrastRequirements: (rawTokens: DesignTokensJSON) => DesignToken[];
/**
 ...
 */
export declare const getContrastRatingForTokenPairing: (filteredTokens: DesignToken[], tokens: AllGenericTokens, pairingKey: 'text_contrast_pairing' | 'uicontrol_contrast_pairing' | 'data_visualization_contrast_pairing') => TokenPairContrastRating[];
/**
 ...
 * @return {*}  {TokenPairContrastRating[]}
 */
export declare const getContrastRatingsOfTokensWithDataVisualizationContrastRequirements: (tokens: Partial<GenericTokensShape>) => TokenPairContrastRating[];
