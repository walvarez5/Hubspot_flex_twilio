...
var Tooltip = React2.forwardRef(
  (_a, ref) => {
    ...
    const tooltip = state || useTooltipPrimitiveState(__spreadValues({ baseId: `paste-tooltip-${useUID()}` }, props));
    return /* @__PURE__ */ React2.createElement(React2.Fragment, null, React2.Children.only(
      /* @__PURE__ */ React2.createElement(TooltipPrimitiveReference, __spreadValues(__spreadProps(__spreadValues({}, tooltip), { ref }), children.props), (referenceProps) => React2.cloneElement(children, referenceProps))
    ), /* @__PURE__ */ React2.createElement(TooltipPrimitive, __spreadProps(__spreadValues(__spreadValues({ element }, tooltip), props), { as: StyledTooltip }), /* @__PURE__ */ React2.createElement(StyledBase, null, /* @__PURE__ */ React2.createElement(TooltipArrow, __spreadValues({}, tooltip)), /* @__PURE__ */ React2.createElement(Text, { element: `${element}_TEXT`, as: "span", color: "colorTextInverse" }, text))));
  }
);
if (false) {
  Tooltip.propTypes = {
