...
var TimePicker = React.forwardRef(
  (_a, ref) => {
    var _b = _a, { step: _step, element = "TIMEPICKER" } = _b, props = __objRest(_b, ["step", "element"]);
    return /* @__PURE__ */ React.createElement(import_input.Input, __spreadProps(__spreadValues({ element }, props), { type: "time", ref }));
  }
);
...
// src/utils.ts
var TIME_REGEX = /^(0\d|1\d|2[0-3]):[0-5]\d(:[0-5]\d)?(.\d{1,3})?$/;
var NEUTRAL_DATE = "2021-06-18T";
var formatReturnTime = (timeValue, timeFormat) => {
