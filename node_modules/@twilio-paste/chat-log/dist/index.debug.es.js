  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React2.createElement(
      ...
      __spreadValues(__spreadValues({
        ...
        ref,
        variant
      }, bubbleVariantStyles[variant]), safelySpreadBoxProps(props)),
      children
    );
  }
);
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React3.createElement(MessageVariantContext.Provider, { value: variant }, /* @__PURE__ */ React3.createElement(
      ...
      __spreadValues(__spreadValues({
        ...
        element,
        variant
      }, messageVariantStyles[variant]), safelySpreadBoxProps2(props)),
      children
    ));
  }
);
...
var ChatLog = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(Box5, __spreadValues({ role: "log", padding: "space70", element, ref }, safelySpreadBoxProps5(props)), /* @__PURE__ */ React6.createElement(
    Box5,
    {
      as: "div",
      role: "list",
...
ComposerAttachmentCard.propTypes = {
  ...
  i18nDismissLabel: PropTypes6.string,
  onDismiss: PropTypes6.func
};
...
var require_tslib = __commonJS({ "../../../node_modules/react-uid/node_modules/tslib/tslib.js"(exports, module) {
...
var Stack = React9.forwardRef((_a, ref) => {
  ...
  return React9.createElement(Box7, __spreadProps2(__spreadValues2(__spreadValues2({ element }, safelySpreadBoxProps7(props)), stackStyles), { ref }), validChildren.map((child, index) => React9.createElement(Box7, __spreadProps2(__spreadValues2({ element: `${element}_CHILD` }, childrenCount !== index + 1 ? childMargins : null), { key: keySeed(`stack-${index}`) }), child)));
});
Stack.displayName = "Stack";
Stack.propTypes = { orientation: ResponsiveProp(PropTypes7.oneOf(["horizontal", "vertical"])).isRequired, spacing: isSpaceTokenProp, element: PropTypes7.string };
...
var ChatAttachment = React10.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React10.createElement(MediaObject, __spreadProps(__spreadValues({}, props), { as: "div", ref, verticalAlign: "center", element }), /* @__PURE__ */ React10.createElement(MediaFigure, { as: "div", spacing: "space30" }, attachmentIcon), /* @__PURE__ */ React10.createElement(MediaBody, { as: "div", element: `${element}_BODY` }, /* @__PURE__ */ React10.createElement(Stack, { orientation: "vertical", spacing: "space10" }, children)));
  }
);
ChatAttachment.displayName = "ChatAttachment";
ChatAttachment.propTypes = {
  children: PropTypes8.node.isRequired,
  element: PropTypes8.string,
  attachmentIcon: PropTypes8.node.isRequired
};
...
var ChatAttachmentLink = React11.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React11.createElement(Anchor, __spreadValues({ href, ref, element }, props), /* @__PURE__ */ React11.createElement(Truncate, { title: children }, children));
  }
);
ChatAttachmentLink.displayName = "ChatAttachmentLink";
ChatAttachmentLink.propTypes = {
  children: PropTypes9.string.isRequired,
...
ChatAttachmentDescription.propTypes = {
  children: PropTypes10.string.isRequired,
...
var ChatBookend = React13.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React13.createElement(
      Box8,
      __spreadProps(__spreadValues({}, safelySpreadBoxProps8(props)), {
        as: "div",
        role: "listitem",
        color: "colorTextWeak",
        element,
...
var ChatBookendItem = React14.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React14.createElement(Box9, __spreadProps(__spreadValues({}, safelySpreadBoxProps9(props)), { as: "div", element, ref }), children);
  }
);
...
var ChatEvent = React15.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React15.createElement(
      Box10,
      __spreadProps(__spreadValues({}, safelySpreadBoxProps10(props)), {
        as: "div",
        role: "listitem",
        color: "colorTextWeak",
        element,
...
var ChatLogger = ({ chats }) => {
  ...
  const animatedChats = useReducedMotion() ? chats.map((chat) => React16.cloneElement(chat.content, { key: chat.id })) : transitions((styles, chat, { key }) => /* @__PURE__ */ React16.createElement(AnimatedChat, { as: "div", style: styles, key }, chat.content));
