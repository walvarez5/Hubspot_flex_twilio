  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React2.createElement(
      ...
      __spreadValues(__spreadValues({
        ...
        ref,
        variant
      }, bubbleVariantStyles[variant]), (0, import_box.safelySpreadBoxProps)(props)),
      children
    );
  }
);
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React3.createElement(MessageVariantContext.Provider, { value: variant }, /* @__PURE__ */ React3.createElement(
      ...
      __spreadValues(__spreadValues({
        ...
        element,
        variant
      }, messageVariantStyles[variant]), (0, import_box2.safelySpreadBoxProps)(props)),
      children
    ));
  }
);
...
ChatMessage.propTypes = {
  ...
  variant: import_prop_types2.default.oneOf(["inbound", "outbound"]).isRequired,
...
var ChatLog = React6.forwardRef((_a, ref) => {
  var _b = _a, { children, element = "CHAT_LOG" } = _b, props = __objRest(_b, ["children", "element"]);
  return /* @__PURE__ */ React6.createElement(import_box5.Box, __spreadValues({ role: "log", padding: "space70", element, ref }, (0, import_box5.safelySpreadBoxProps)(props)), /* @__PURE__ */ React6.createElement(
    import_box5.Box,
    {
      as: "div",
      role: "list",
...
var ComposerAttachmentCard = React7.forwardRef(
  (_a, ref) => {
    var _b = _a, { children, onDismiss, i18nDismissLabel = "Remove attachment", element = "COMPOSER_ATTACHMENT_CARD" } = _b, props = __objRest(_b, ["children", "onDismiss", "i18nDismissLabel", "element"]);
...
ComposerAttachmentCard.propTypes = {
  ...
  i18nDismissLabel: import_prop_types6.default.string,
  onDismiss: import_prop_types6.default.func
};
...
var require_tslib = __commonJS({ "../../../node_modules/react-uid/node_modules/tslib/tslib.js"(exports, module2) {
  ...
  (function(factory) {
    ...
    }) : typeof module2 == "object" && typeof module2.exports == "object" ? factory(createExporter(root, createExporter(module2.exports))) : factory(createExporter(root));
    ...
    __extends2 = function(d, b) {
      ...
      for (var p in m)
        p !== "default" && !exports2.hasOwnProperty(p) && (exports2[p] = m[p]);
...
var generateUID = function() {
  var counter2 = 1, map = /* @__PURE__ */ new WeakMap(), uid2 = function(item, index) {
    return typeof item == "number" || typeof item == "string" ? index ? "idx-" + index : "val-" + item : map.has(item) ? "uid" + map.get(item) : (map.set(item, counter2++), uid2(item));
  };
  return uid2;
};
var uid = generateUID();
...
var source = React8.createContext(createSource());
...
var { __extends, __assign, __rest, __decorate, __param, __metadata, __awaiter, __generator, __exportStar, __createBinding, __values, __read, __spread, __spreadArrays, __await, __asyncGenerator, __asyncDelegator, __asyncValues, __makeTemplateObject, __importStar, __importDefault, __classPrivateFieldGet, __classPrivateFieldSet } = import_tslib.default;
...
var UID = function(_super) {
  ...
  function UID2() {
    ...
    return _this.state = { quartz: _this.props.idSource || counter, prefix: getPrefix(_this.props.idSource), id: getId(_this.props.idSource || counter) }, _this.uid = function(item) {
      return prefixId(_this.state.id + "-" + _this.state.quartz.uid(item), _this.state.prefix, _this.props.name);
    }, _this;
  }
  return UID2.prototype.render = function() {
    var _a = this.props, children = _a.children, name = _a.name, _b = this.state, id = _b.id, prefix = _b.prefix;
...
var useUIDState = function() {
  return React42.useState(generateUID2(React42.useContext(source)));
};
...
var __spreadValues2 = (a, b) => {
  for (var prop in b || (b = {}))
    __hasOwnProp3.call(b, prop) && __defNormalProp2(a, prop, b[prop]);
...
var __objRest2 = (source2, exclude) => {
  var target = {};
  for (var prop in source2)
    __hasOwnProp3.call(source2, prop) && exclude.indexOf(prop) < 0 && (target[prop] = source2[prop]);
  if (source2 != null && __getOwnPropSymbols2)
    for (var prop of __getOwnPropSymbols2(source2))
      exclude.indexOf(prop) < 0 && __propIsEnum2.call(source2, prop) && (target[prop] = source2[prop]);
  return target;
};
...
var Stack = React9.forwardRef((_a, ref) => {
  var _b = _a, { children, orientation, spacing, element = "STACK" } = _b, props = __objRest2(_b, ["children", "orientation", "spacing", "element"]);
  let [childrenCount, validChildren] = React9.useMemo(() => {
    let filteredChildren = React9.Children.toArray(children).filter((child) => React9.isValidElement(child) || typeof child == "string");
    return [filteredChildren.length, filteredChildren];
  }, [children]), stackStyles = React9.useMemo(() => getStackStyles(orientation), [orientation]), childMargins = React9.useMemo(() => getStackChildMargins(orientation, spacing), [orientation, spacing]), keySeed = useUIDSeed();
  return React9.createElement(import_box7.Box, __spreadProps2(__spreadValues2(__spreadValues2({ element }, (0, import_box7.safelySpreadBoxProps)(props)), stackStyles), { ref }), validChildren.map((child, index) => React9.createElement(import_box7.Box, __spreadProps2(__spreadValues2({ element: `${element}_CHILD` }, childrenCount !== index + 1 ? childMargins : null), { key: keySeed(`stack-${index}`) }), child)));
});
Stack.displayName = "Stack";
Stack.propTypes = { orientation: (0, import_style_props.ResponsiveProp)(import_prop_types7.default.oneOf(["horizontal", "vertical"])).isRequired, spacing: import_style_props.isSpaceTokenProp, element: import_prop_types7.default.string };

// src/ChatAttachment.tsx
var ChatAttachment = React10.forwardRef(
  (_a, ref) => {
    var _b = _a, { children, element = "CHAT_ATTACHMENT", attachmentIcon } = _b, props = __objRest(_b, ["children", "element", "attachmentIcon"]);
    return /* @__PURE__ */ React10.createElement(import_media_object.MediaObject, __spreadProps(__spreadValues({}, props), { as: "div", ref, verticalAlign: "center", element }), /* @__PURE__ */ React10.createElement(import_media_object.MediaFigure, { as: "div", spacing: "space30" }, attachmentIcon), /* @__PURE__ */ React10.createElement(import_media_object.MediaBody, { as: "div", element: `${element}_BODY` }, /* @__PURE__ */ React10.createElement(Stack, { orientation: "vertical", spacing: "space10" }, children)));
  }
);
...
ChatAttachment.propTypes = {
  ...
  attachmentIcon: import_prop_types8.default.node.isRequired
};
...
var ChatAttachmentLink = React11.forwardRef(
  (_a, ref) => {
    var _b = _a, { children, href, element = "CHAT_ATTACHMENT_LINK" } = _b, props = __objRest(_b, ["children", "href", "element"]);
    return /* @__PURE__ */ React11.createElement(import_anchor.Anchor, __spreadValues({ href, ref, element }, props), /* @__PURE__ */ React11.createElement(import_truncate.Truncate, { title: children }, children));
  }
);
ChatAttachmentLink.displayName = "ChatAttachmentLink";
ChatAttachmentLink.propTypes = {
  children: import_prop_types9.default.string.isRequired,
  element: import_prop_types9.default.string
};
...
var ChatAttachmentDescription = React12.forwardRef(
  (_a, ref) => {
    var _b = _a, { children, element = "CHAT_ATTACHMENT_DESCRIPTION" } = _b, props = __objRest(_b, ["children", "element"]);
    return /* @__PURE__ */ React12.createElement(
      import_text.Text,
      __spreadProps(__spreadValues({}, (0, import_text.safelySpreadTextProps)(props)), {
        element,
        ref,
        as: "div",
        fontSize: "fontSize20",
...
ChatAttachmentDescription.propTypes = {
  children: import_prop_types10.default.string.isRequired,
  element: import_prop_types10.default.string
};
...
var ChatBookend = React13.forwardRef(
  (_a, ref) => {
    var _b = _a, { children, element = "CHAT_BOOKEND" } = _b, props = __objRest(_b, ["children", "element"]);
    return /* @__PURE__ */ React13.createElement(
      import_box8.Box,
      __spreadProps(__spreadValues({}, (0, import_box8.safelySpreadBoxProps)(props)), {
        as: "div",
        role: "listitem",
        color: "colorTextWeak",
        element,
...
ChatBookend.propTypes = {
  ...
  element: import_prop_types11.default.string
};
...
var ChatBookendItem = React14.forwardRef(
  (_a, ref) => {
    var _b = _a, { children, element = "CHAT_BOOKEND_ITEM" } = _b, props = __objRest(_b, ["children", "element"]);
    return /* @__PURE__ */ React14.createElement(import_box9.Box, __spreadProps(__spreadValues({}, (0, import_box9.safelySpreadBoxProps)(props)), { as: "div", element, ref }), children);
  }
);
ChatBookendItem.displayName = "ChatBookendItem";
ChatBookendItem.propTypes = {
  children: import_prop_types12.default.node,
  element: import_prop_types12.default.string
};
...
var ChatEvent = React15.forwardRef(
  (_a, ref) => {
    var _b = _a, { children, element = "CHAT_EVENT" } = _b, props = __objRest(_b, ["children", "element"]);
    return /* @__PURE__ */ React15.createElement(
      import_box10.Box,
      __spreadProps(__spreadValues({}, (0, import_box10.safelySpreadBoxProps)(props)), {
        as: "div",
        role: "listitem",
        color: "colorTextWeak",
        element,
...
ChatEvent.propTypes = {
  ...
  element: import_prop_types13.default.string
};
...
var ChatLogger = ({ chats }) => {
  ...
  const animatedChats = (0, import_animation_library.useReducedMotion)() ? chats.map((chat) => React16.cloneElement(chat.content, { key: chat.id })) : transitions((styles, chat, { key }) => /* @__PURE__ */ React16.createElement(AnimatedChat, { as: "div", style: styles, key }, chat.content));
  return /* @__PURE__ */ React16.createElement(ChatLog, null, animatedChats);
};
ChatLogger.displayName = "ChatLogger";

// src/useChatLogger.ts
var React17 = __toESM(require("react"));
var chatWithId = (chat) => __spreadProps(__spreadValues({}, chat), { id: chat.id || uid(chat.content) });
var useChatLogger = (...initialChats) => {
  const parsedInitialChats = React17.useMemo(() => initialChats.map(chatWithId), [initialChats]);
  const [chats, setChats] = React17.useState(parsedInitialChats);
