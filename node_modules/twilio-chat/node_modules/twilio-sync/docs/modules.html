...
<head>
	...
	<title>twilio-sync | twilio-sync</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-class">
			<a href="classes/InsightsItem.html" class="tsd-kind-icon">Insights<wbr>Item</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/InstantQuery.html" class="tsd-kind-icon">Instant<wbr>Query</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/LiveQuery.html" class="tsd-kind-icon">Live<wbr>Query</a>
		</li>
		<li class=" tsd-kind-class tsd-has-type-parameter">
			<a href="classes/Paginator.html" class="tsd-kind-icon">Paginator</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/SyncClient.html" class="tsd-kind-icon">Sync<wbr>Client</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/SyncDocument.html" class="tsd-kind-icon">Sync<wbr>Document</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/SyncList.html" class="tsd-kind-icon">Sync<wbr>List</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/SyncListItem.html" class="tsd-kind-icon">Sync<wbr>List<wbr>Item</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/SyncMap.html" class="tsd-kind-icon">Sync<wbr>Map</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/SyncMapItem.html" class="tsd-kind-icon">Sync<wbr>Map<wbr>Item</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/SyncStream.html" class="tsd-kind-icon">Sync<wbr>Stream</a>
		</li>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<a href="#twilio-sync-javascript-client-library" id="twilio-sync-javascript-client-library" style="color: inherit; text-decoration: none;">
				<h1>Twilio Sync JavaScript client library</h1>
			</a>
			<p>Twilio Sync is Twilio&#39;s state synchronization service, offering two-way real-time communication between browsers, mobiles, and the cloud.
			...
			<pre><code><span style="color: #001080">npm</span><span style="color: #000000"> </span><span style="color: #001080">install</span><span style="color: #000000"> --</span><span style="color: #001080">save</span><span style="color: #000000"> </span><span style="color: #001080">twilio</span><span style="color: #000000">-</span><span style="color: #001080">sync</span>
</code></pre>
			<p>Using this method, you can <code>require</code> twilio-sync.js like so:</p>
			<pre><code><span style="color: #0000FF">const</span><span style="color: #000000"> { </span><span style="color: #0070C1">SyncClient</span><span style="color: #000000"> } = </span><span style="color: #795E26">require</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;twilio-sync&#039;</span><span style="color: #000000">);</span>
<span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">syncClient</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #795E26">SyncClient</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>
</code></pre>
			<a href="#via-cdn" id="via-cdn" style="color: inherit; text-decoration: none;">
				<h3>via CDN</h3>
			</a>
			<p>Releases of twilio-sync.js are hosted on a CDN, and you can include these
			directly in your web app using a &lt;script&gt; tag.</p>
			<pre><code><span style="color: #000000">&lt;</span><span style="color: #001080">script</span><span style="color: #000000"> </span><span style="color: #001080">type</span><span style="color: #000000">=</span><span style="color: #A31515">&quot;text/javascript&quot;</span><span style="color: #000000"> </span><span style="color: #001080">src</span><span style="color: #000000">=</span><span style="color: #A31515">&quot;//sdk.twilio.com/js/sync/v3.2/twilio-sync.min.js&quot;</span><span style="color: #000000">&gt;&lt;/</span><span style="color: #267F99">script</span><span style="color: #000000">&gt;</span>
</code></pre>
			<p>Using this method, twilio-sync.js will set a browser global:</p>
			<pre><code><span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">syncClient</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #001080">Twilio</span><span style="color: #000000">.</span><span style="color: #001080">Sync</span><span style="color: #000000">.</span><span style="color: #795E26">Client</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>
</code></pre>
			<a href="#usage" id="usage" style="color: inherit; text-decoration: none;">
				<h2>Usage</h2>
			</a>
			<p>To use the library, you need to generate an <a href="https://www.twilio.com/docs/sync/identity-and-access-tokens">Access Token</a> and pass it to the Sync Client constructor.
			...
			<pre><code><span style="color: #008000">// Obtain a JWT access token: https://www.twilio.com/docs/sync/identity-and-access-tokens</span>
<span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">token</span><span style="color: #000000"> = </span><span style="color: #A31515">&#039;&lt;your-access-token-here&gt;&#039;</span><span style="color: #000000">;</span>
<span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">syncClient</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #001080">Twilio</span><span style="color: #000000">.</span><span style="color: #001080">Sync</span><span style="color: #000000">.</span><span style="color: #795E26">Client</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>

<span style="color: #008000">// Open a Document by unique name and update its data</span>
<span style="color: #001080">syncClient</span><span style="color: #000000">.</span><span style="color: #795E26">document</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;MyDocument&#039;</span><span style="color: #000000">)</span>
<span style="color: #000000">  .</span><span style="color: #795E26">then</span><span style="color: #000000">(</span><span style="color: #0000FF">function</span><span style="color: #000000">(</span><span style="color: #001080">document</span><span style="color: #000000">) {</span>
<span style="color: #000000">    </span><span style="color: #008000">// Listen to updates on the Document</span>
<span style="color: #000000">    </span><span style="color: #001080">document</span><span style="color: #000000">.</span><span style="color: #795E26">on</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;updated&#039;</span><span style="color: #000000">, </span><span style="color: #0000FF">function</span><span style="color: #000000">(</span><span style="color: #001080">event</span><span style="color: #000000">) {</span>
<span style="color: #000000">      </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">log</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;Received Document update event. New data:&#039;</span><span style="color: #000000">, </span><span style="color: #001080">event</span><span style="color: #000000">.</span><span style="color: #001080">data</span><span style="color: #000000">);</span>
<span style="color: #000000">    });</span>

<span style="color: #000000">    </span><span style="color: #008000">// Update the Document data</span>
<span style="color: #000000">    </span><span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">newData</span><span style="color: #000000"> = { </span><span style="color: #001080">temperature:</span><span style="color: #000000"> </span><span style="color: #098658">23</span><span style="color: #000000"> };</span>
<span style="color: #000000">    </span><span style="color: #AF00DB">return</span><span style="color: #000000"> </span><span style="color: #001080">document</span><span style="color: #000000">.</span><span style="color: #795E26">set</span><span style="color: #000000">(</span><span style="color: #001080">newData</span><span style="color: #000000">);</span>
<span style="color: #000000">  })</span>
<span style="color: #000000">  .</span><span style="color: #795E26">then</span><span style="color: #000000">(</span><span style="color: #0000FF">function</span><span style="color: #000000">(</span><span style="color: #001080">updateResult</span><span style="color: #000000">) {</span>
<span style="color: #000000">    </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">log</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;The Document was successfully updated&#039;</span><span style="color: #000000">, </span><span style="color: #001080">updateResult</span><span style="color: #000000">)</span>
<span style="color: #000000">  })</span>
<span style="color: #000000">  .</span><span style="color: #795E26">catch</span><span style="color: #000000">(</span><span style="color: #0000FF">function</span><span style="color: #000000">(</span><span style="color: #001080">error</span><span style="color: #000000">) {</span>
<span style="color: #000000">    </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">error</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;Unexpected error&#039;</span><span style="color: #000000">, </span><span style="color: #001080">error</span><span style="color: #000000">)</span>
<span style="color: #000000">  });</span>
</code></pre>
			<p>For more code examples for Documents and other Sync objects, refer to the <a href="https://sdk.twilio.com/js/sync/latest/docs">SDK API Docs</a>.</p>
			<a href="#changelog" id="changelog" style="color: inherit; text-decoration: none;">
				<h2>Changelog</h2>
			</a>
			<p>See this <a href="https://www.twilio.com/docs/sync/javascript/changelog">link</a>.</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-reference"><a href="modules.html#Client" class="tsd-kind-icon">Client</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Classes</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-class"><a href="classes/InsightsItem.html" class="tsd-kind-icon">Insights<wbr>Item</a></li>
							<li class="tsd-kind-class"><a href="classes/InstantQuery.html" class="tsd-kind-icon">Instant<wbr>Query</a></li>
							<li class="tsd-kind-class"><a href="classes/LiveQuery.html" class="tsd-kind-icon">Live<wbr>Query</a></li>
							<li class="tsd-kind-class tsd-has-type-parameter"><a href="classes/Paginator.html" class="tsd-kind-icon">Paginator</a></li>
							<li class="tsd-kind-class"><a href="classes/SyncClient.html" class="tsd-kind-icon">Sync<wbr>Client</a></li>
							<li class="tsd-kind-class"><a href="classes/SyncDocument.html" class="tsd-kind-icon">Sync<wbr>Document</a></li>
							<li class="tsd-kind-class"><a href="classes/SyncList.html" class="tsd-kind-icon">Sync<wbr>List</a></li>
							<li class="tsd-kind-class"><a href="classes/SyncListItem.html" class="tsd-kind-icon">Sync<wbr>List<wbr>Item</a></li>
							<li class="tsd-kind-class"><a href="classes/SyncMap.html" class="tsd-kind-icon">Sync<wbr>Map</a></li>
							<li class="tsd-kind-class"><a href="classes/SyncMapItem.html" class="tsd-kind-icon">Sync<wbr>Map<wbr>Item</a></li>
							<li class="tsd-kind-class"><a href="classes/SyncStream.html" class="tsd-kind-icon">Sync<wbr>Stream</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface"><a href="interfaces/ItemsSnapshot.html" class="tsd-kind-icon">Items<wbr>Snapshot</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/OpenDocumentOptions.html" class="tsd-kind-icon">Open<wbr>Document<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/OpenListOptions.html" class="tsd-kind-icon">Open<wbr>List<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/OpenMapOptions.html" class="tsd-kind-icon">Open<wbr>Map<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/OpenOptions.html" class="tsd-kind-icon">Open<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/OpenStreamOptions.html" class="tsd-kind-icon">Open<wbr>Stream<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/SyncClientOptions.html" class="tsd-kind-icon">Sync<wbr>Client<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/SyncDocumentMetadata.html" class="tsd-kind-icon">Sync<wbr>Document<wbr>Metadata</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/SyncListItemMetadata.html" class="tsd-kind-icon">Sync<wbr>List<wbr>Item<wbr>Metadata</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/SyncListItemQueryOptions.html" class="tsd-kind-icon">Sync<wbr>List<wbr>Item<wbr>Query<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/SyncMapItemMetadata.html" class="tsd-kind-icon">Sync<wbr>Map<wbr>Item<wbr>Metadata</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/SyncMapItemQueryOptions.html" class="tsd-kind-icon">Sync<wbr>Map<wbr>Item<wbr>Query<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/SyncStreamMessage.html" class="tsd-kind-icon">Sync<wbr>Stream<wbr>Message</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Type aliases</h3>
						<ul class="tsd-index-list">
							...
							<li class="tsd-kind-type-alias"><a href="modules.html#Mutator" class="tsd-kind-icon">Mutator</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#OpenMode" class="tsd-kind-icon">Open<wbr>Mode</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-reference">
				...
				<h3>Client</h3>
				Renames and exports <a href="classes/SyncClient.html">SyncClient</a>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			<h2>Type aliases</h2>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Client connection state.
							Directly reflects connection state of the underlying websocket transport.
						Possible values are as follows:</p>
						<ul>
							<li>&#39;connecting&#39; - client is offline and connection attempt is in process.</li>
							<li>&#39;connected&#39; - client is online and ready.</li>
							<li>&#39;disconnecting&#39; - client is going offline as disconnection is in process.</li>
							<li>&#39;disconnected&#39; - client is offline and no connection attempt is in process.</li>
							<li>&#39;denied&#39; - client connection is denied because of invalid JWT access token. User must refresh token in order to proceed.</li>
							<li>&#39;error&#39; - client connection is in a permanent erroneous state. Client re-initialization is required.</li>
						</ul>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="Mutator" class="tsd-anchor"></a>
				<h3>Mutator</h3>
				<div class="tsd-signature tsd-kind-icon">Mutator<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">(</span>currentValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">Object</span></div>
				<aside class="tsd-sources">
				</aside>
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter-signature">
							<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-alias">
								<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>currentValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Object</span></li>
							</ul>
							<ul class="tsd-descriptions">
								<li class="tsd-description">
									<div class="tsd-comment tsd-typography">
										<div class="lead">
											<p>Applies a transformation to the data of a Sync entity. May be called multiple times on the
											same datum in case of collisions with remote code.</p>
										</div>
									</div>
									<h4 class="tsd-parameters-title">Parameters</h4>
									<ul class="tsd-parameters">
										<li>
											<h5>currentValue: <span class="tsd-signature-type">Object</span></h5>
											<div class="tsd-comment tsd-typography">
												<div class="lead">
													<p>Current data of the Sync entity in the cloud.</p>
												</div>
											</div>
										</li>
									</ul>
									<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Object</span></h4>
									<p>Desired new data for the item or <code>null</code> to gracefully cancel the mutation.</p>
								</li>
							</ul>
						</li>
					</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<h3>Open<wbr>Mode</h3>
				<div class="tsd-signature tsd-kind-icon">Open<wbr>Mode<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">&quot;open_or_create&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;open_existing&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;create_new&quot;</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Mode for opening the Sync object:</p>
						<ul>
							<li><code>&#39;open_or_create&#39;</code> - reads a Sync object or creates one if it does not exist.</li>
							<li><code>&#39;open_existing&#39;</code> - reads an existing Sync object. The promise is rejected if the object does not exist.</li>
							<li><code>&#39;create_new&#39;</code> - creates a new Sync object. If the <em>id</em> property is specified, it will be used as the unique name.</li>
						</ul>
					</div>
				</div>
			</section>
