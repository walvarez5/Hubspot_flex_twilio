...
<head>
	...
	<title>InstantQuery | twilio-sync</title>
		...
		<li class="current tsd-kind-class">
			...
			<ul>
				<li class=" tsd-kind-event tsd-parent-kind-class tsd-is-static">
					<a href="InstantQuery.html#searchResult" class="tsd-kind-icon">search<wbr>Result</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="InstantQuery.html#search" class="tsd-kind-icon">search</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="InstantQuery.html#subscribe" class="tsd-kind-icon">subscribe</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="InstantQuery.html#updateIndexName" class="tsd-kind-icon">update<wbr>Index<wbr>Name</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-class">
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Allows repetitive quick searches against specific Flex data.
						Unlike a LiveQuery, this result set does not subscribe to any updates and therefore
					receives no events beyond the initial result set.</p>
				</div>
				<p>Use the <a href="SyncClient.html#instantQuery">SyncClient.instantQuery</a> method to create an Instant Query.</p>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="tsd-signature-type">ReplayEventEmitter</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">InstantQueryEvents</span><span class="tsd-signature-symbol">&gt;</span>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">InstantQuery</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-event tsd-parent-kind-class tsd-is-static"><a href="InstantQuery.html#searchResult" class="tsd-kind-icon">search<wbr>Result</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="InstantQuery.html#search" class="tsd-kind-icon">search</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="InstantQuery.html#subscribe" class="tsd-kind-icon">subscribe</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="InstantQuery.html#updateIndexName" class="tsd-kind-icon">update<wbr>Index<wbr>Name</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-event tsd-parent-kind-class tsd-is-static">
				...
				<h3><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagReadonly">Readonly</span> search<wbr>Result</h3>
				<div class="tsd-signature tsd-kind-icon">search<wbr>Result<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">&quot;searchResult&quot;</span><span class="tsd-signature-symbol"> = &#x27;searchResult&#x27;</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Fired when a search result is ready.</p>
					</div>
					<p>Parameters:</p>
					<ol>
						<li><a href="../interfaces/ItemsSnapshot.html">ItemsSnapshot</a> <code>items</code> - a snapshot of items matching current query expression.</li>
					</ol>
					<dl class="tsd-comment-tags">
						<dt>example</dt>
						<dd><pre><code class="language-typescript"><span style="color: #001080">instantQuery</span><span style="color: #000000">.</span><span style="color: #795E26">on</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;searchResult&#039;</span><span style="color: #000000">, (</span><span style="color: #001080">items</span><span style="color: #000000">) </span><span style="color: #0000FF">=&gt;</span><span style="color: #000000"> {</span>
<span style="color: #000000">   </span><span style="color: #267F99">Object</span><span style="color: #000000">.</span><span style="color: #795E26">entries</span><span style="color: #000000">(</span><span style="color: #001080">items</span><span style="color: #000000">).</span><span style="color: #795E26">forEach</span><span style="color: #000000">(([</span><span style="color: #001080">key</span><span style="color: #000000">, </span><span style="color: #001080">value</span><span style="color: #000000">]) </span><span style="color: #0000FF">=&gt;</span><span style="color: #000000"> {</span>
<span style="color: #000000">     </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">log</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;Search result item key:&#039;</span><span style="color: #000000">, </span><span style="color: #001080">key</span><span style="color: #000000">);</span>
<span style="color: #000000">     </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">log</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;Search result item value:&#039;</span><span style="color: #000000">, </span><span style="color: #001080">value</span><span style="color: #000000">);</span>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Spawns a new search request. The result will be provided asynchronously via the <a href="InstantQuery.html#searchResult">InstantQuery.searchResult</a>
								event.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>queryExpression: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>A query expression to be executed against the given data index. For more information
									on the syntax read <a href="SyncClient.html#liveQuery">SyncClient.liveQuery</a>.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>A promise that resolves when query result has been received.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3>subscribe</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">subscribe<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="LiveQuery.html" class="tsd-signature-type" data-tsd-kind="Class">LiveQuery</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Instantiates a LiveQuery object based on the last known query expression that was passed to the
								...
								while current object can be still used to execute repetitive searches.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="LiveQuery.html" class="tsd-signature-type" data-tsd-kind="Class">LiveQuery</a><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>A promise which resolves when the LiveQuery object is ready.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="updateIndexName" class="tsd-anchor"></a>
				<h3>update<wbr>Index<wbr>Name</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">update<wbr>Index<wbr>Name<span class="tsd-signature-symbol">(</span>indexName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
