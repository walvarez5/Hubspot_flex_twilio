...
<head>
	...
	<title>LiveQuery | twilio-sync</title>
		...
		<li class="current tsd-kind-class">
			...
			<ul>
				<li class=" tsd-kind-event tsd-parent-kind-class tsd-is-static">
					<a href="LiveQuery.html#itemRemoved" class="tsd-kind-icon">item<wbr>Removed</a>
				</li>
				<li class=" tsd-kind-event tsd-parent-kind-class tsd-is-static">
					<a href="LiveQuery.html#itemUpdated" class="tsd-kind-icon">item<wbr>Updated</a>
				</li>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class">
					<a href="LiveQuery.html#sid" class="tsd-kind-icon">sid</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-overwrite">
					<a href="LiveQuery.html#close" class="tsd-kind-icon">close</a>
				</li>
			</ul>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Represents a long-running query against Flex data wherein the returned result set
				...
				<p>Use the <a href="SyncClient.html#liveQuery">SyncClient.liveQuery</a> method to create a live query.</p>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					...
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">LiveQuery</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-event tsd-parent-kind-class tsd-is-static"><a href="LiveQuery.html#itemRemoved" class="tsd-kind-icon">item<wbr>Removed</a></li>
							<li class="tsd-kind-event tsd-parent-kind-class tsd-is-static"><a href="LiveQuery.html#itemUpdated" class="tsd-kind-icon">item<wbr>Updated</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Accessors</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="LiveQuery.html#sid" class="tsd-kind-icon">sid</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="LiveQuery.html#close" class="tsd-kind-icon">close</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-event tsd-parent-kind-class tsd-is-static">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Fired when an existing item has been removed.</p>
					</div>
					<p>Parameters:</p>
					<ol>
						<li>object <code>args</code> - info object provided with the event. It has the following properties:<ul>
								<li>object <code>key</code> - the key of the removed item</li>
							</ul>
						</li>
					</ol>
					<dl class="tsd-comment-tags">
						<dt>example</dt>
						<dd><pre><code class="language-typescript"><span style="color: #001080">liveQuery</span><span style="color: #000000">.</span><span style="color: #795E26">on</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;itemRemoved&#039;</span><span style="color: #000000">, (</span><span style="color: #001080">args</span><span style="color: #000000">) </span><span style="color: #0000FF">=&gt;</span><span style="color: #000000"> {</span>
<span style="color: #000000">  </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">log</span><span style="color: #000000">(</span><span style="color: #A31515">`Item </span><span style="color: #0000FF">${</span><span style="color: #001080">args</span><span style="color: #000000FF">.</span><span style="color: #001080">key</span><span style="color: #0000FF">}</span><span style="color: #A31515"> was removed`</span><span style="color: #000000">);</span>
<span style="color: #000000">});</span>
			...
			<section class="tsd-panel tsd-member tsd-kind-event tsd-parent-kind-class tsd-is-static">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Fired when an item has been added or updated.</p>
					</div>
					<p>Parameters:</p>
					<ol>
						<li><a href="InsightsItem.html">InsightsItem</a> <code>item</code> - updated item</li>
					</ol>
					<dl class="tsd-comment-tags">
						<dt>example</dt>
						<dd><pre><code class="language-typescript"><span style="color: #001080">liveQuery</span><span style="color: #000000">.</span><span style="color: #795E26">on</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;itemUpdated&#039;</span><span style="color: #000000">, (</span><span style="color: #001080">item</span><span style="color: #000000">) </span><span style="color: #0000FF">=&gt;</span><span style="color: #000000"> {</span>
<span style="color: #000000">  </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">log</span><span style="color: #000000">(</span><span style="color: #A31515">`Item </span><span style="color: #0000FF">${</span><span style="color: #001080">item</span><span style="color: #000000FF">.</span><span style="color: #001080">key</span><span style="color: #0000FF">}</span><span style="color: #A31515"> was updated`&#039;`)</span><span style="color: #CD3131">;</span>
<span style="color: #000000">  </span><span style="color: #001080">console</span><span style="color: #000000">.</span><span style="color: #795E26">log</span><span style="color: #000000">(</span><span style="color: #A31515">&#039;Item value:&#039;</span><span style="color: #000000">, </span><span style="color: #001080">item</span><span style="color: #000000">.</span><span style="color: #001080">value</span><span style="color: #000000">);</span>
<span style="color: #000000">});</span>
</code></pre>
						</dd>
					</dl>
			...
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>The immutable identifier of this query object, assigned by the system.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Closes this query instance and unsubscribes from further service events.
									This will eventually stop the physical inflow of updates over the network,
								when all other instances of this query are closed as well.</p>
							</div>
						</div>
