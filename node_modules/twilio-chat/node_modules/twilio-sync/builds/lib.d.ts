...
declare class SyncListItem {
     ...
     * @internal
     */
    update(eventId: number, revision: string, data: Record<string, unknown>, dateUpdated: Date): SyncListItem;
    /**
     * @internal
     */
...
declare class Paginator<Item> {
    private prevPageItemId;
    private nextPageItemId;
    private source;
    /**
     ...
     * @internal
     */
    constructor(items: any, source: any, prevItemId?: string | number | null, nextItemId?: string | number | null);
    /**
     * Request next page.
...
declare class SyncListImpl extends SyncEntity {
    ...
    set(index: number, value: Record<string, unknown>, itemMetadataUpdates?: SyncListItemMetadata): Promise<SyncListItem>;
     ...
     * @private
     */
    protected queryItems(args?: any): Promise<Paginator<SyncListItem>>;
    private _prevPageAllowed;
    private _nextPageAllowed;
    ...
    protected _querySingleItemFromServer(index: number): Promise<Paginator<SyncListItem>>;
    protected _queryItemsFromServer(args: any): Promise<Paginator<SyncListItem>>;
...
declare class SyncList extends Closeable {
     ...
     * ```
     */
    update(index: number, obj: Record<string, unknown>, itemMetadataUpdates?: SyncListItemMetadata): Promise<SyncListItem>;
    /**
...
declare class SyncMapItem {
     ...
     * @internal
     */
    update(eventId: number, revision: string, value: Record<string, unknown>, dateUpdated: Date): SyncMapItem;
    /**
     * @internal
     */
    updateDateExpires(dateExpires: string): void;
...
declare class SyncMapImpl extends SyncEntity {
    ...
    get uniqueName(): string;
    get dateUpdated(): Date;
    set(key: string, value: Record<string, unknown>, itemMetadataUpdates?: SyncMapItemMetadata): Promise<SyncMapItem>;
    ...
    update(key: string, obj: Record<string, unknown>, itemMetadataUpdates?: SyncMapItemMetadata): Promise<SyncMapItem>;
    ...
    // - order of items asc/desc
    private makePaginator;
    protected _querySingleItemFromServer(key: string): Promise<Paginator<SyncMapItem>>;
    protected _queryItemsFromServer(args: any): Promise<Paginator<SyncMapItem>>;
...
declare class SyncMap extends Closeable {
     ...
     * ```
     */
    set(key: string, data: Record<string, unknown>, itemMetadataUpdates?: SyncMapItemMetadata): Promise<SyncMapItem>;
    /**
...
declare class InsightsItem {
     ...
     * @internal
     */
    constructor(key: string, value: Record<string, unknown>, lastEventId: number);
    /**
