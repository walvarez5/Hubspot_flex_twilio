...
class Client extends events_1.EventEmitter {
    constructor(fpaToken, options = {}) {
        ...
        if (startTwilsock && !options.initRegistrations) {
            let initRegistration = new twilsock_1.InitRegistration(productId);
        ...
        this.services.subscriptions = new subscriptions_1.Subscriptions(this.services);
    ...
    async liveQuery(indexName, queryExpression) {
        await this.ensureReady();
        const queryUri = new uri_1.UriBuilder(this.services.config.insightsUri)
            .pathSegment(indexName)
            .pathSegment('Items')
            .build();
        // send query to CDS to get server-generated sid and item list
        const response = await livequery_2.queryItems({
    ...
    async instantQuery(indexName) {
        ...
        return new livequery_1.InstantQuery({
            indexName,
            network: this.services.network,
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync([
        'undefined',
        'string',
        twilio_sdk_type_validator_1.objectSchema('open document options', {
            id: ['string', 'undefined'],
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync([
        'undefined',
        'string',
        twilio_sdk_type_validator_1.objectSchema('open map options', {
            id: ['string', 'undefined'],
            mode: [twilio_sdk_type_validator_1.literal('open_or_create', 'open_existing', 'create_new'), 'undefined'],
            ttl: [twilio_sdk_type_validator_1.nonNegativeInteger, 'undefined'],
            data: [twilio_sdk_type_validator_1.pureObject, 'undefined', twilio_sdk_type_validator_1.literal(null)],
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync([
        'undefined',
        'string',
        twilio_sdk_type_validator_1.objectSchema('open list options', {
            id: ['string', 'undefined'],
            mode: [twilio_sdk_type_validator_1.literal('open_or_create', 'open_existing', 'create_new'), 'undefined'],
            ttl: [twilio_sdk_type_validator_1.nonNegativeInteger, 'undefined'],
            data: [twilio_sdk_type_validator_1.pureObject, 'undefined', twilio_sdk_type_validator_1.literal(null)],
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync([
        'undefined',
        'string',
        twilio_sdk_type_validator_1.objectSchema('open stream options', {
            id: ['string', 'undefined'],
            mode: [twilio_sdk_type_validator_1.literal('open_or_create', 'open_existing', 'create_new'), 'undefined'],
            ttl: [twilio_sdk_type_validator_1.nonNegativeInteger, 'undefined'],
            data: [twilio_sdk_type_validator_1.pureObject, 'undefined', twilio_sdk_type_validator_1.literal(null)]
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync(twilio_sdk_type_validator_1.nonEmptyString, 'string'),
    __metadata("design:type", Function),
