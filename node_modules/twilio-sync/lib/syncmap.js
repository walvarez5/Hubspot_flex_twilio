...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync('string', twilio_sdk_type_validator_1.pureObject, [
        'undefined',
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync('string', 'function', [
        'undefined',
        twilio_sdk_type_validator_1.objectSchema('item metadata', {
            ttl: [twilio_sdk_type_validator_1.nonNegativeInteger, 'undefined']
        })
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync('string', twilio_sdk_type_validator_1.nonNegativeInteger),
    __metadata("design:type", Function),
