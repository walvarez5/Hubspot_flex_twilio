...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync(twilio_sdk_type_validator_1.pureObject, [
        'undefined',
        twilio_sdk_type_validator_1.objectSchema('item metadata', {
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync(twilio_sdk_type_validator_1.nonNegativeInteger, twilio_sdk_type_validator_1.pureObject, [
        'undefined',
        twilio_sdk_type_validator_1.objectSchema('item metadata', {
            ttl: [twilio_sdk_type_validator_1.nonNegativeInteger, 'undefined']
        })
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync(twilio_sdk_type_validator_1.nonNegativeInteger, 'function', [
        'undefined',
        twilio_sdk_type_validator_1.objectSchema('item metadata', {
            ttl: [twilio_sdk_type_validator_1.nonNegativeInteger, 'undefined']
        })
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync([
        'undefined',
        twilio_sdk_type_validator_1.objectSchema('query options', {
            from: [twilio_sdk_type_validator_1.nonNegativeInteger, 'undefined'],
            pageSize: [twilio_sdk_type_validator_1.custom((value) => [sanitize_1.isPositiveInteger(value), 'a positive integer']), 'undefined']
        })
    ]),
    __metadata("design:type", Function),
...
__decorate([
    twilio_sdk_type_validator_1.validateTypesAsync(twilio_sdk_type_validator_1.nonNegativeInteger, twilio_sdk_type_validator_1.nonNegativeInteger),
    __metadata("design:type", Function),
