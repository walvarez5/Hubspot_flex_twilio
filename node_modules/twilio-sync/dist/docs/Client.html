...
Valid options are [&apos;unknown&apos;, &apos;connecting&apos;, &apos;connected&apos;, &apos;disconnecting&apos;, &apos;disconnected&apos;, &apos;denied&apos;, &apos;error&apos;].</td>
        </tr>
...
</p><li>&apos;unknown&apos; - client is offline and is not attempting to connect.
</li><li>&apos;connecting&apos; - client is offline and connection attempt is in process.
